...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-12 items-center justify-start border-b border-border bg-transparent p-0 text-muted-foreground w-full',
      className,
    )}
    {...props}
  />
