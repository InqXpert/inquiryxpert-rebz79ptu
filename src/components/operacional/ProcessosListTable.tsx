          ...
          <Table className="table-fixed w-full">
            <TableHeader className="bg-brand-light/30 dark:bg-black/10">
              <TableRow className="hover:bg-transparent border-b-brand-teal/20 dark:border-b-brand-cyan/20">
                ...
                <TableHead className="w-[16%] font-bold text-brand-navy dark:text-white">
                  STATUS
                </TableHead>
                <TableHead className="w-[16%] font-bold text-brand-navy dark:text-white">
                  SUPERVISOR
                </TableHead>
                <TableHead className="w-[14%] font-bold text-brand-navy dark:text-white">
                  SEGURADORA
                </TableHead>
                <TableHead className="w-[12%] font-bold text-brand-navy dark:text-white">
                  TIPO
                </TableHead>
                <TableHead className="w-[14%] hidden lg:table-cell font-bold text-brand-navy dark:text-white">
                  AGENTE
                </TableHead>
                <TableHead className="w-[10%] font-bold text-brand-navy dark:text-white">
                  ENTRADA
                </TableHead>
