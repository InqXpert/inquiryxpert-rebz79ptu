...
import {
  ...
  Q as isNumber,
  W as warn,
  d as useArbitraryXAxis,
  f as useChartHeight,
  h as useYAxisWithFiniteDomainOrRandom,
  it as require_isFunction,
  k as getCoordinatesOfGrid,
  l as CartesianAxis,
  m as useOffset,
  p as useChartWidth,
  u as getTicks,
} from './chart-DYgwE-IV.js'
//#region ../../cache/modules/gerenciador-de-prestadores-d53d6/node_modules/.pnpm/recharts@2.15.4_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/recharts/es6/cartesian/CartesianGrid.js
...
var defaultVerticalCoordinatesGenerator = function defaultVerticalCoordinatesGenerator(
  ...
  return getCoordinatesOfGrid(
    getTicks(
      _objectSpread(
        _objectSpread(_objectSpread({}, CartesianAxis.defaultProps), xAxis),
        {},
        {
...
var defaultHorizontalCoordinatesGenerator = function defaultHorizontalCoordinatesGenerator(
  ...
  return getCoordinatesOfGrid(
    getTicks(
      _objectSpread(
        _objectSpread(_objectSpread({}, CartesianAxis.defaultProps), yAxis),
        {},
        {
...
function CartesianGrid(props) {
  ...
  var propsIncludingDefaults = _objectSpread(
    _objectSpread({}, props),
    {},
    {
      stroke:
  ...
  return /* @__PURE__ */ import_react.createElement(
    ...
    /* @__PURE__ */ import_react.createElement(
      HorizontalGridLines,
      _extends({}, propsIncludingDefaults, {
        offset,
        horizontalPoints,
        xAxis,
        yAxis,
    ...
    /* @__PURE__ */ import_react.createElement(
      HorizontalStripes,
      _extends({}, propsIncludingDefaults, { horizontalPoints }),
    ),
    /* @__PURE__ */ import_react.createElement(
      VerticalStripes,
      _extends({}, propsIncludingDefaults, { verticalPoints }),
    ),
  )
}
...
//# sourceMappingURL=CartesianGrid-CBUIAo1I.js.map
