  ...
  render() {
    if (this.state.hasError)
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        ...
        'data-prohibitions': '[]',
        className:
          'flex flex-col items-center justify-center min-h-[400px] w-full p-8 bg-card rounded-2xl border border-border shadow-sm text-center',
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
            ...
            children:
              'Encontramos um erro inesperado ao processar esta tela. Por favor, tente recarregar a página. Se o problema persistir, contate o suporte.',
          }),
...
function GestaoAgentesLayout() {
  ...
  const { user } = useAuth()
  if (!user || !['c-level', 'admin', 'supervisor', 'agente'].includes(user.role))
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GestaoAgentesErrorBoundary, {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.Suspense, {
              ...
              fallback: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                ...
                'data-prohibitions': '[]',
                className:
                  'flex flex-col items-center justify-center min-h-[400px] w-full text-muted-foreground',
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                    'data-uid': 'src/pages/gestao-agentes/Layout.tsx:78:19',
                    'data-prohibitions': '[editContent]',
                    className:
                      'w-10 h-10 rounded-full border-[3px] border-primary border-t-transparent animate-spin mb-4',
                  }),
...
//# sourceMappingURL=Layout-BKOoAtle.js.map
