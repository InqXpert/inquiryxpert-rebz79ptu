...
import { t as MessageCircle } from './message-circle-B-rYwytx.js'
...
import {
  ...
  r as createProcesso,
  u as getNextNumeroControle,
} from './procesosOperacionais-QbmNogI8.js'
import { t as Textarea } from './textarea-BWQ2EUcv.js'
import { t as Label } from './label-B6kYntjL.js'
import { n as getAgente } from './agentes-Cm62P0yd.js'
...
function Sindicancia() {
  ...
  const handleFileSelect = (e) => {
    ...
    if (
      files.reduce((acc, f) => acc + f.size, 0) + selected.reduce((acc, f) => acc + f.size, 0) >
      MAX_FILE_SIZE
    ) {
      toast({
        title: 'Erro',
  ...
  if (loading)
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
      ...
      'data-prohibitions': '[]',
      className:
        'w-full max-w-5xl mx-auto px-4 sm:px-6 md:px-8 py-6 md:py-8 pb-12 space-y-8 animate-pulse',
      children: [
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
    ...
    'data-prohibitions': '[editContent]',
    className:
      'w-full max-w-5xl mx-auto px-4 sm:px-6 md:px-8 py-6 md:py-8 pb-12 space-y-8 animate-in fade-in duration-500',
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
        'data-uid': 'src/pages/agentes/Sindicancia.tsx:159:7',
        'data-prohibitions': '[editContent]',
        className:
          'flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-8',
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
              ...
              size: 'sm',
              className:
                'gap-2 text-[15px] font-semibold text-muted-foreground hover:text-primary hover:bg-transparent px-0 mb-4',
              onClick: () => navigate(-1),
              children: [
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Textarea, {
                          ...
                          id: 'orientacoes',
                          placeholder:
                            'Descreva detalhadamente o que o agente deve realizar nesta sindicância...',
                          className:
                            'min-h-[260px] resize-y rounded-2xl p-5 text-[15px] leading-relaxed border-border focus-visible:ring-secondary/50 shadow-sm',
                          value: orientacoes,
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                      ...
                      'data-prohibitions': '[]',
                      className:
                        'border-2 border-dashed border-border rounded-2xl p-12 flex flex-col items-center justify-center text-center hover:bg-muted/30 transition-colors cursor-pointer bg-muted/10',
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('h5', {
                            ...
                            'data-prohibitions': '[]',
                            className:
                              'text-[13px] font-bold text-muted-foreground uppercase tracking-wider mb-4',
                          ...
                          files.map((f, idx) =>
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                              'div',
                              {
                                ...
                                'data-prohibitions': '[editContent]',
                                className:
                                  'flex items-center justify-between p-4 bg-background rounded-xl border border-border group shadow-sm',
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                    ...
                                    children: [
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                                        ...
                                        'data-prohibitions': '[]',
                                        className:
                                          'w-10 h-10 rounded-lg bg-muted flex items-center justify-center shrink-0 border border-border/50',
                                      ...
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                        ...
                                        children: [
                                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                                            ...
                                            'data-prohibitions': '[editContent]',
                                            className:
                                              'text-[15px] font-bold text-foreground truncate',
                                            children: f.name,
                                          }),
                                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('span', {
                                            ...
                                            'data-prohibitions': '[editContent]',
                                            className:
                                              'text-[13px] font-medium text-muted-foreground mt-0.5',
                                  ...
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                                    ...
                                    size: 'icon',
                                    className:
                                      'text-destructive opacity-0 group-hover:opacity-100 transition-opacity h-10 w-10',
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                    ...
                    variant: 'outline',
                    className:
                      'w-full h-14 rounded-xl justify-start font-bold text-primary border-primary hover:bg-primary/5 text-[15px]',
                    children: saving
                      ? 'Salvando...'
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                    ...
                    disabled: saving,
                    className:
                      'w-full h-14 rounded-xl justify-start font-bold bg-primary hover:bg-primary/90 text-primary-foreground text-[15px] shadow-sm',
                    children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                    ...
                    disabled: saving,
                    className:
                      'w-full h-14 rounded-xl justify-start font-bold bg-emerald-600 hover:bg-emerald-700 text-white text-[15px] shadow-sm',
                    children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                    ...
                    variant: 'ghost',
                    className:
                      'w-full h-14 rounded-xl text-[15px] font-bold text-muted-foreground hover:text-foreground',
                    children: 'Cancelar',
                  }),
                  draftProcess &&
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                      ...
                      'data-prohibitions': '[editContent]',
                      className:
                        'mt-8 p-6 bg-emerald-50 rounded-2xl border border-emerald-200 flex flex-col items-center text-center animate-in zoom-in-95',
                      children: [
...
//# sourceMappingURL=Sindicancia-De_Uipfo.js.map
