...
import { L as ChevronRight, M as Button$1, N as buttonVariants } from './index-DJeO_T7s.js'
...
function syncToInternal(date) {
  ...
  date.internal.setUTCSeconds(
    date.internal.getUTCSeconds() - Math.round(-tzOffset(date.timeZone, date) * 60),
  )
}
/**
...
function adjustToSystemTZ(date) {
  ...
  const systemSecondsOffset =
    systemOffset > 0 ? systemDate.getSeconds() : (systemDate.getSeconds() - 60) % 60
  ...
  if (offsetChanged && postDiff) {
    ...
    const offsetChange =
      postOffset - (newBaseOffset > 0 ? Math.floor(newBaseOffset) : Math.ceil(newBaseOffset))
    if (offsetChange) {
...
function Chevron(props) {
  ...
  return import_react.createElement(
    ...
    orientation === 'up' &&
      import_react.createElement('polygon', {
...
function Weekdays(props) {
  return import_react.createElement(
    'thead',
    { 'aria-hidden': true },
    import_react.createElement('tr', { ...props }),
  )
}
//#endregion
...
function createGetModifiers(days, props, navStart, navEnd, dateLib) {
  ...
  return (day) => {
    ...
    for (const name in internalModifiersMap)
      dayFlags[name] = internalModifiersMap[name].some((d) => d === day)
...
function createNoonOverrides(timeZone, options = {}) {
  ...
  return {
    ...
    endOfWeek: (date, options) => {
      const base = toNoonTZDate(date)
      const diff =
        ((((options?.weekStartsOn ?? fallbackWeekStartsOn) + 6) % 7) - base.getDay() + 7) % 7
      base.setDate(base.getDate() + diff)
      return base
    },
    endOfISOWeek: (date) => {
...
function getMonths(displayMonths, dates, props, dateLib) {
  ...
  const dayPickerMonths = displayMonths.reduce((months, month) => {
    ...
    const dayPickerMonth = new CalendarMonth(
      month,
      monthDates.reduce((weeks, date) => {
...
function getNavMonths(props, dateLib) {
  ...
  const { startOfYear, startOfDay, startOfMonth, endOfMonth, addYears, endOfYear, newDate, today } =
    dateLib
  ...
  if (
    matchers
      ...
      .some((matcher) => {
        ...
        if (isDateInterval(matcher)) {
          if (dateLib.isAfter(matcher.before, matcher.after))
            return rangeOverlaps(
              range,
              {
...
function DayPicker(initialProps) {
  ...
  const { components, formatters, labels, dateLib, locale, classNames } = (0,
  ...
  const handleDayFocus = (0, import_react.useCallback)(
    (day, m) => (e) => {
      setFocused(day)
  ...
  const handleDayBlur = (0, import_react.useCallback)(
    (day, m) => (e) => {
      blur()
  ...
  const handleDayKeyDown = (0, import_react.useCallback)(
    (day, modifiers) => (e) => {
      const keyMap = {
  ...
  const handleDayMouseEnter = (0, import_react.useCallback)(
    (day, modifiers) => (e) => {
      onDayMouseEnter?.(day.date, modifiers, e)
    },
    [onDayMouseEnter],
  )
  const handleDayMouseLeave = (0, import_react.useCallback)(
    (day, modifiers) => (e) => {
    ...
    import_react.createElement(
      ...
      import_react.createElement(
        ...
        !props.hideNavigation &&
          !navLayout &&
          import_react.createElement(components.Nav, {
                    ...
                    (() => {
                      const monthControl =
                        captionLayout === 'dropdown' || captionLayout === 'dropdown-months'
                          ? import_react.createElement(components.MonthsDropdown, {
                              key: 'month',
                      ...
                      const yearControl =
                        captionLayout === 'dropdown' || captionLayout === 'dropdown-years'
                          ? import_react.createElement(components.YearsDropdown, {
                              key: 'year',
                      ...
                      return dateLib.getMonthYearOrder() === 'year-first'
                        ...
                        !modifiers.hidden && isInteractive
                          ? import_react.createElement(
                              components.DayButton,
                              {
                                ...
                                'aria-disabled':
                                  (modifiers.focused && modifiers.disabled) || void 0,
...
function Calendar({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DayPicker, {
    ...
    classNames: {
      ...
      caption_label: cn(
        'select-none font-semibold text-lg text-foreground',
        captionLayout === 'label'
          ? ''
      ...
      weekday: cn(
        'text-muted-foreground flex-1 select-none rounded-md text-xs font-semibold text-center',
      ...
      day: cn(
        'group/day relative flex w-full items-center justify-center select-none p-0 text-center text-sm font-medium text-foreground [&:first-child[data-selected=true]_button]:rounded-full [&:last-child[data-selected=true]_button]:rounded-full',
    ...
    components: {
      ...
      Chevron: ({ className, orientation, ...props }) => {
        if (orientation === 'left')
          return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronLeft, {
        ...
        if (orientation === 'right')
          return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRight, {
...
function CalendarDayButton({ className, day, modifiers, ...props }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button$1, {
    ...
    className: cn(
      'data-[selected-single=true]:bg-primary data-[selected-single=true]:text-primary-foreground data-[range-middle=true]:bg-accent data-[range-middle=true]:text-accent-foreground data-[range-start=true]:bg-primary data-[range-start=true]:text-primary-foreground data-[range-end=true]:bg-primary data-[range-end=true]:text-primary-foreground group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-ring/50 flex size-[--cell-size] flex-col gap-1 font-medium text-sm leading-none rounded-md hover:bg-secondary cursor-pointer group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:ring-[3px] [&>span]:text-xs [&>span]:opacity-70',
      defaultClassNames.day,
      className,
    ),
    ...props,
...
//# sourceMappingURL=calendar-DuV7KqlJ.js.map
