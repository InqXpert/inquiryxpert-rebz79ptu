...
import { a as SelectValue, i as SelectTrigger, n as SelectContent, r as SelectItem, t as Select } from "./select-CWNeD5aB.js";
import { t as CircleAlert } from "./circle-alert-DNvso6yJ.js";
import { t as CircleCheck } from "./circle-check-DPipDoWr.js";
import { t as CircleX } from "./circle-x-BaRWQhac.js";
import { t as Clock } from "./clock-Ba7IQEbS.js";
import { t as CloudUpload } from "./cloud-upload-PVTWWkaP.js";
...
import { t as File } from "./file-BdBwcsop.js";
...
import { t as X } from "./x-DUNH1unN.js";
...
import { G as useParams, W as useNavigate, j as Button, r as getErrorMessage } from "./index-BWhopxaq.js";
...
function ProcessStatus({ processoId, currentStatus }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		"data-uid": "src/pages/processos/Documentos.tsx:18:5",
		"data-prohibitions": "[editContent]",
		className: "bg-card border rounded-lg p-4 shadow-sm",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
			"data-uid": "src/pages/processos/Documentos.tsx:19:7",
			"data-prohibitions": "[]",
			className: "text-sm font-medium text-muted-foreground mb-1",
			children: "Status do Processo"
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			"data-uid": "src/pages/processos/Documentos.tsx:20:7",
			"data-prohibitions": "[editContent]",
			className: "font-semibold capitalize text-lg text-foreground",
			children: currentStatus || "Não informado"
		})]
	});
}
function BannerAviso() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		"data-uid": "src/pages/processos/Documentos.tsx:29:5",
		"data-prohibitions": "[]",
		className: "bg-amber-50 dark:bg-amber-950/30 text-amber-800 dark:text-amber-200 p-4 rounded-lg border border-amber-200 dark:border-amber-800/50 flex gap-3 items-start",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, {
			"data-uid": "src/pages/processos/Documentos.tsx:30:7",
			"data-prohibitions": "[editContent]",
			className: "w-5 h-5 shrink-0 mt-0.5"
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			"data-uid": "src/pages/processos/Documentos.tsx:31:7",
			"data-prohibitions": "[]",
			className: "text-sm",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				"data-uid": "src/pages/processos/Documentos.tsx:32:9",
				"data-prohibitions": "[]",
				className: "font-medium mb-1",
				children: "Upload de Evidências"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				"data-uid": "src/pages/processos/Documentos.tsx:33:9",
				"data-prohibitions": "[]",
				children: "Certifique-se de que os arquivos contêm informações legíveis e estão nos formatos permitidos para a plataforma."
			})]
		})]
	});
}
function ProcessoDocumentosPage() {
	...
	if (loading) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		"data-uid": "src/pages/processos/Documentos.tsx:49:7",
		"data-prohibitions": "[]",
		className: "p-6 space-y-6 max-w-7xl mx-auto w-full",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Skeleton, {
			"data-uid": "src/pages/processos/Documentos.tsx:50:9",
			"data-prohibitions": "[editContent]",
			className: "h-10 w-1/3"
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			"data-uid": "src/pages/processos/Documentos.tsx:51:9",
			"data-prohibitions": "[]",
			className: "grid grid-cols-1 lg:grid-cols-12 gap-6",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				"data-uid": "src/pages/processos/Documentos.tsx:52:11",
				"data-prohibitions": "[]",
				className: "lg:col-span-4",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Skeleton, {
					"data-uid": "src/pages/processos/Documentos.tsx:53:13",
					"data-prohibitions": "[editContent]",
					className: "h-[400px]"
				})
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				"data-uid": "src/pages/processos/Documentos.tsx:55:11",
				"data-prohibitions": "[]",
				className: "lg:col-span-8",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Skeleton, {
					"data-uid": "src/pages/processos/Documentos.tsx:56:13",
					"data-prohibitions": "[editContent]",
					className: "h-[600px]"
				})
			})]
	...
	if (error || !processo) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		"data-uid": "src/pages/processos/Documentos.tsx:65:7",
		"data-prohibitions": "[editContent]",
		className: "flex flex-col items-center justify-center h-[60vh] space-y-4",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			"data-uid": "src/pages/processos/Documentos.tsx:66:9",
			"data-prohibitions": "[editContent]",
			className: "text-xl text-muted-foreground font-medium",
			children: error || "Processo não encontrado"
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
			"data-uid": "src/pages/processos/Documentos.tsx:69:9",
			"data-prohibitions": "[]",
			variant: "outline",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		"data-uid": "src/pages/processos/Documentos.tsx:79:5",
		"data-prohibitions": "[editContent]",
		className: "p-4 sm:p-6 max-w-7xl mx-auto w-full animate-in fade-in duration-300",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			"data-uid": "src/pages/processos/Documentos.tsx:80:7",
			"data-prohibitions": "[editContent]",
			className: "flex items-center space-x-4 mb-6",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
				"data-uid": "src/pages/processos/Documentos.tsx:81:9",
				"data-prohibitions": "[]",
				variant: "outline",
				onClick: () => navigate(`/processos/${id}`),
				className: "text-foreground h-10 px-4",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowLeft, {
					"data-uid": "src/pages/processos/Documentos.tsx:86:11",
					"data-prohibitions": "[editContent]",
					className: "w-4 h-4 mr-2"
				}), " Voltar para Processo"]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				"data-uid": "src/pages/processos/Documentos.tsx:88:9",
				"data-prohibitions": "[editContent]",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
					"data-uid": "src/pages/processos/Documentos.tsx:89:11",
					"data-prohibitions": "[editContent]",
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FolderOpen, {
							"data-uid": "src/pages/processos/Documentos.tsx:90:13",
							"data-prohibitions": "[editContent]",
					...
					"data-uid": "src/pages/processos/Documentos.tsx:93:11",
					"data-prohibitions": "[]",
					className: "text-sm text-muted-foreground mt-1",
			...
			"data-uid": "src/pages/processos/Documentos.tsx:99:7",
			"data-prohibitions": "[]",
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(BannerAviso, {
						"data-uid": "src/pages/processos/Documentos.tsx:102:11",
						"data-prohibitions": "[editContent]"
					}),
...
//# sourceMappingURL=Documentos-D1sL9b7d.js.map