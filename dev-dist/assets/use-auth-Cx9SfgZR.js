      ...
      try {
        ...
        if (sessionId) {
          ...
          const diffMins = Math.floor(
            (/* @__PURE__ */ new Date().getTime() - start.getTime()) / 6e4,
          )
          ...
          await pb
            .collection('users')
            .update(u.id, { tempo_uso_total: (u.tempo_uso_total || 0) + diffMins })
      ...
      if (pb.authStore.isValid)
        try {
          ...
          if (sessionId) {
            ...
            if (
              (/* @__PURE__ */ new Date().getTime() - new Date(sess.updated).getTime()) /
                (1e3 * 60 * 60) >
                8 ||
              sess.expirada
            ) {
            ...
            await pb
              ...
              .update(sessionId, { updated: /* @__PURE__ */ new Date().toISOString() })
          }
  ...
  const signIn = async (email, password) => {
    try {
      ...
      try {
        await pb
          .collection('users')
          .update(authData.record.id, { ultimo_login: /* @__PURE__ */ new Date().toISOString() })
...
//# sourceMappingURL=use-auth-Cx9SfgZR.js.map
