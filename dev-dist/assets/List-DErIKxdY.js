...
import {
  ...
  s as CommandList,
  t as useMunicipios,
} from './use-municipios-BYXKcPF2.js'
import { t as CircleCheck } from './circle-check-CSFqsJLD.js'
import { t as ImportAgenteModal } from './ImportAgenteModal-jC465O3o.js'
import { t as MapPin } from './map-pin-BTSuVZ-G.js'
...
import { r as getAgentes } from './agentes-Cm62P0yd.js'
import { n as PopoverContent, r as PopoverTrigger, t as Popover } from './popover-X-c-rr-V.js'
...
function useGeoDistance() {
  ...
  return {
    calculateDistance,
    findNearestAgent: (0, import_react.useCallback)(
      (investigationCoords, agents) => {
...
function InteractiveMapBrazil({
  ...
  ;(0, import_react.useEffect)(() => {
    ...
    const markers = []
    const createIcon = (color, glow = false) =>
      L.divIcon({
...
function InvestigationMap({ agentes, loading: agentsLoading }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
    ...
    'data-prohibitions': '[editContent]',
    className:
      'rounded-2xl shadow-sm border border-border/50 overflow-hidden flex flex-col mt-8 animate-in fade-in zoom-in duration-300 bg-card',
    children: [
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CommandGroup, {
                                  ...
                                  children: states.map((s) =>
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                      ...
                                      {
                                        'data-uid':
                                          'src/components/agentes/InvestigationMap.tsx:149:25',
                                        'data-prohibitions': '[editContent]',
                                        value: s,
                                        ...
                                        onSelect: (currentValue) => {
                                          const actualValue =
                                            states.find(
                                              (st) =>
                                                st.toLowerCase() === currentValue.toLowerCase(),
                                            ) || currentValue
                                        ...
                                        children: [
                                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, {
                                            'data-uid':
                                              'src/components/agentes/InvestigationMap.tsx:163:27',
                                            'data-prohibitions': '[editContent]',
                                            className: cn(
                                              'mr-3 h-4 w-4',
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CommandGroup, {
                                  ...
                                  children: cities.map((c) =>
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                      ...
                                      {
                                        'data-uid':
                                          'src/components/agentes/InvestigationMap.tsx:208:25',
                                        'data-prohibitions': '[editContent]',
                                        value: c.nome,
                                        className: 'font-medium cursor-pointer',
                                        onSelect: (currentValue) => {
                                        ...
                                        children: [
                                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, {
                                            'data-uid':
                                              'src/components/agentes/InvestigationMap.tsx:221:27',
                                            'data-prohibitions': '[editContent]',
                                            className: cn(
                                              'mr-3 h-4 w-4',
        ...
        children: [
          !invCity
            ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                ...
                'data-prohibitions': '[]',
                className:
                  'absolute inset-0 flex flex-col items-center justify-center text-muted-foreground z-10 bg-background/50 backdrop-blur-[2px]',
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, {
            ...
            : mappedAgents.length === 0
              ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                  ...
                  'data-prohibitions': '[]',
                  className:
                    'absolute inset-0 flex flex-col items-center justify-center text-muted-foreground z-10 bg-background/50 backdrop-blur-[2px] pointer-events-none',
                  children: [
              ...
              : null,
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InteractiveMapBrazil, {
      ...
      selectedAgentInfo &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
          ...
          'data-prohibitions': '[editContent]',
          className:
            'p-6 sm:p-8 bg-secondary/10 border-t border-secondary/20 flex flex-col sm:flex-row items-center justify-between gap-6 animate-in slide-in-from-bottom-4',
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                  ...
                  'data-prohibitions': '[editContent]',
                  className:
                    'flex flex-wrap gap-5 mt-3 text-[15px] text-primary/80 font-semibold bg-white/50 px-4 py-2 rounded-lg border border-secondary/20 w-fit',
                  children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
              ...
              'data-prohibitions': '[]',
              className:
                'rounded-xl h-12 px-8 bg-secondary hover:bg-secondary/90 text-secondary-foreground font-bold w-full sm:w-auto shadow-sm text-[15px]',
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tabs, {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        ...
        'data-prohibitions': '[editContent]',
        className:
          'bg-white border-b border-border pt-6 md:pt-8 px-4 sm:px-6 md:px-8 flex-shrink-0 shadow-sm z-10',
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            'data-uid': 'src/pages/agentes/List.tsx:76:9',
            'data-prohibitions': '[editContent]',
            className:
              'flex flex-col md:flex-row justify-between items-start md:items-center mb-6 max-w-[1600px] mx-auto w-full gap-6',
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('h1', {
                    ...
                    'data-prohibitions': '[]',
                    className:
                      'font-bold text-[#2A3B4C] flex items-center gap-2 tracking-tight mb-2 text-[28px]',
                    children: [
                      'Gestão de Agentes',
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, {
                        ...
                        'data-prohibitions': '[editContent]',
                        className:
                          'w-6 h-6 text-muted-foreground mt-0.5 cursor-pointer hover:text-[#00A8B5] transition-colors',
                      }),
                    ],
                  }),
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                'data-uid': 'src/pages/agentes/List.tsx:84:11',
                'data-prohibitions': '[]',
                className: 'flex items-center gap-3 mt-4 md:mt-0 w-full sm:w-auto',
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                    'data-uid': 'src/pages/agentes/List.tsx:85:13',
                    'data-prohibitions': '[]',
                    variant: 'outline',
                    className:
                      'h-11 text-[14px] font-semibold text-[#2A3B4C] border-border bg-[#fdfdfd] shadow-sm hover:bg-muted/50 rounded-xl flex-1 sm:flex-none',
                    children: [
                      'Ações ',
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, {
                        'data-uid': 'src/pages/agentes/List.tsx:89:21',
                        'data-prohibitions': '[editContent]',
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                    'data-uid': 'src/pages/agentes/List.tsx:91:13',
                    'data-prohibitions': '[]',
                    variant: 'outline',
                    className:
                      'h-11 text-[14px] font-semibold text-[#2A3B4C] border-border bg-[#fdfdfd] shadow-sm hover:bg-muted/50 rounded-xl flex-1 sm:flex-none',
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                    'data-uid': 'src/pages/agentes/List.tsx:98:13',
                    'data-prohibitions': '[]',
                    className:
                      'h-11 text-[14px] font-semibold bg-[#F2485C] hover:bg-[#F2485C]/90 text-white shadow-sm px-6 rounded-xl flex-1 sm:flex-none',
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
            'data-uid': 'src/pages/agentes/List.tsx:107:9',
            'data-prohibitions': '[]',
            className: 'max-w-[1600px] mx-auto w-full',
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsList, {
              'data-uid': 'src/pages/agentes/List.tsx:108:11',
              'data-prohibitions': '[]',
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsTrigger, {
                  ...
                  value: 'list',
                  className:
                    'px-2 py-4 font-semibold text-muted-foreground data-[state=active]:text-[#00A8B5] data-[state=active]:border-[#00A8B5] data-[state=active]:border-b-[3px] border-b-[3px] border-transparent rounded-none bg-transparent hover:bg-transparent shadow-none transition-all text-[14px]',
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsTrigger, {
                  ...
                  value: 'map',
                  className:
                    'px-2 py-4 font-semibold text-muted-foreground data-[state=active]:text-[#00A8B5] data-[state=active]:border-[#00A8B5] data-[state=active]:border-b-[3px] border-b-[3px] border-transparent rounded-none bg-transparent hover:bg-transparent shadow-none transition-all text-[15px]',
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        ...
        'data-prohibitions': '[editContent]',
        className:
          'flex-1 px-4 sm:px-6 md:px-8 py-6 md:py-8 pb-12 flex flex-col max-w-[1600px] mx-auto w-full space-y-8',
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsContent, {
            ...
            value: 'list',
            className:
              'm-0 bg-white border border-border/50 shadow-sm rounded-2xl flex-1 flex flex-col overflow-hidden',
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectTrigger, {
                        'data-uid': 'src/pages/agentes/List.tsx:133:15',
                        'data-prohibitions': '[]',
                        className:
                          'h-11 w-full sm:w-[180px] border-border bg-transparent shadow-none text-[14px] font-semibold text-[#2A3B4C] focus:ring-2 focus:ring-[#00A8B5] rounded-xl',
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                    ...
                    variant: 'ghost',
                    className:
                      'h-11 text-[14px] text-[#00A8B5] hover:text-[#00A8B5]/80 hover:bg-[#00A8B5]/10 px-4 font-semibold ml-1 rounded-xl',
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
                        ...
                        className:
                          'pl-12 h-12 text-[14px] border-border bg-white shadow-none rounded-xl focus-visible:ring-2 focus-visible:ring-[#00A8B5] focus-visible:border-[#00A8B5]',
                        value: search,
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                        ...
                        size: 'sm',
                        className:
                          'h-12 px-5 text-[14px] font-semibold border-border text-[#2A3B4C] rounded-xl',
                        children: 'Exportar',
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                      ...
                      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableRow, {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                            ...
                            'data-prohibitions': '[]',
                            className:
                              'text-[12px] font-bold text-[#2A3B4C] uppercase tracking-wider py-5',
                            children: 'NOME',
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                        ...
                        filtered.map((p) =>
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                            TableRow,
                            {
                              ...
                              'data-prohibitions': '[editContent]',
                              className:
                                'cursor-pointer group hover:bg-[#f5f8fa]/60 transition-colors',
                              children: [
                                  ...
                                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                    ...
                                    children: [
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                                        ...
                                        'data-prohibitions': '[editContent]',
                                        className:
                                          'w-10 h-10 rounded-full bg-[#00A8B5]/10 text-[#00A8B5] flex items-center justify-center font-bold text-[14px] shrink-0 border border-[#00A8B5]/20',
                                      ...
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                        ...
                                        children: [
                                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                                            ...
                                            'data-prohibitions': '[editContent]',
                                            className:
                                              'text-[#00A8B5] font-semibold group-hover:underline text-[15px]',
                                          ...
                                          (p.cpf || p.cnpj) &&
                                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                                              ...
                                              'data-prohibitions': '[editContent]',
                                              className:
                                                'text-[13px] text-muted-foreground font-medium mt-1',
                                  ...
                                  children:
                                    p.naBlackList === 'Sim'
                                      ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                          ...
                                          'data-prohibitions': '[]',
                                          className:
                                            'flex items-center gap-2 text-destructive font-bold text-[13px] bg-destructive/10 px-3 py-1.5 rounded-full w-fit',
                                          children: [
                                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                              LockKeyhole,
                                              {
                                      ...
                                      : p.ativo === 'Sim'
                                        ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                            ...
                                            'data-prohibitions': '[]',
                                            className:
                                              'flex items-center gap-2 text-emerald-700 font-bold text-[13px] bg-emerald-100 px-3 py-1.5 rounded-full w-fit',
                                            children: [
                                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                                CircleCheck,
                                                {
                                        ...
                                        : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                            ...
                                            'data-prohibitions': '[]',
                                            className:
                                              'flex items-center gap-2 text-muted-foreground font-bold text-[13px] bg-muted px-3 py-1.5 rounded-full w-fit',
                                            children: [
                                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                                LockOpen,
                                                {
              ...
              filtered.length > 0 &&
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                  ...
                  'data-prohibitions': '[editContent]',
                  className:
                    'p-5 border-t border-border bg-white flex items-center justify-between text-[14px] font-medium text-muted-foreground mt-auto',
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('span', {
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                              ...
                              'data-prohibitions': '[]',
                              className:
                                'w-8 h-8 rounded-lg flex items-center justify-center bg-[#00A8B5]/10 text-[#00A8B5] font-bold text-[13px]',
                              children: '1',
                            }),
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsContent, {
            ...
            value: 'map',
            className:
              'm-0 bg-white border border-border/50 shadow-sm rounded-2xl flex-1 flex flex-col p-4 sm:p-8 min-h-[600px]',
...
//# sourceMappingURL=List-DErIKxdY.js.map
