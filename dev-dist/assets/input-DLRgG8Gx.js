...
import { a as useComposedRefs, i as composeRefs } from "./dist-BKbcLo2h.js";
import { n as useCallbackRef$1, t as useLayoutEffect2 } from "./dist-Dx-S3KmG.js";
...
var Input = import_react.forwardRef(({ className, type, ...props }, ref) => {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
		...
		type,
		className: cn("flex min-h-[44px] md:h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-cyan/50 focus-visible:border-brand-cyan disabled:cursor-not-allowed disabled:opacity-50 md:text-sm dark:bg-brand-navy/50 dark:border-brand-cyan/50 dark:text-white", className),
		ref,
		...props
	});
});
...
//#endregion
export { createContext2 as C, Check as D, Search as E, useControllableState as S, composeEventHandlers as T, createCollection as _, Portal as a, createSlot as b, Content as c, useSize as d, useId as f, useDirection as g, DismissableLayer as h, Presence as i, Root2 as l, useFocusGuards as m, ReactRemoveScroll as n, Anchor as o, FocusScope as p, hideOthers as r, Arrow as s, Input as t, createPopperScope as u, Primitive as v, createContextScope as w, createSlottable as x, dispatchDiscreteCustomEvent as y };

//# sourceMappingURL=input-DLRgG8Gx.js.map