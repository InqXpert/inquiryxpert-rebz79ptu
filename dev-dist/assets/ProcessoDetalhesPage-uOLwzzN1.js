...
import {
  ...
  p as createSlottable,
} from './Combination-CxZgKZyH.js'
import {
  a as Portal,
  c as Trigger,
  i as Overlay,
  l as WarningProvider,
  n as Content,
  o as Root,
  r as Description,
  s as Title,
  t as Close,
  u as createDialogScope,
} from './dist-zDf1m8v_.js'
import {
  A as Button,
  T as useAuth,
  U as useNavigate,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
            ...
            onClick: () => navigate(-1),
            className:
              'text-brand-gray hover:text-brand-navy dark:text-brand-light dark:hover:text-white active:scale-[0.98] transition-transform duration-100',
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            ...
            'data-prohibitions': '[editContent]',
            className:
              'bg-white dark:bg-brand-navy/80 border border-brand-teal/20 dark:border-brand-cyan/20 rounded-xl p-6 shadow-sm',
            children: [
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    'div',
                    {
                      ...
                      'data-prohibitions': '[editContent]',
                      className:
                        'bg-brand-light/30 dark:bg-black/10 p-3 rounded-[6px] flex flex-col space-y-1 animate-in fade-in slide-in-from-bottom-2 duration-300 fill-mode-both border border-brand-teal/10 dark:border-brand-cyan/10',
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                          ...
                          'data-prohibitions': '[editContent]',
                          className:
                            'text-sm font-medium text-brand-navy dark:text-white break-all',
                          children: i.v,
                        }),
                      ],
                    },
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                ...
                children: formFields.map((field, idx) =>
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    'div',
                    {
                      ...
                      'data-prohibitions': '[editContent]',
                      className:
                        'space-y-2 animate-in fade-in slide-in-from-bottom-2 duration-300 fill-mode-both',
                      ...
                      children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
                            ...
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
                                ...
                                'data-prohibitions': '[]',
                                className:
                                  'focus:ring-brand-cyan focus:border-brand-cyan border-brand-teal/20 dark:border-brand-cyan/20',
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectContent, {
                                ...
                                children: field.opts?.map((o) =>
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                    SelectItem,
                                    {
                                      'data-uid':
                                        'src/pages/processos/ProcessoDetalhesPage.tsx:314:25',
                                      'data-prohibitions': '[editContent]',
                                      value: o,
                        ...
                        field.type === 'input' &&
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
                            ...
                            className:
                              'focus-visible:ring-brand-cyan focus-visible:border-brand-cyan border-brand-teal/20 dark:border-brand-cyan/20',
                          }),
                        field.type === 'relation' &&
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectContent, {
                                ...
                                children: field.opts?.map((o) =>
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                    ...
                                    {
                                      'data-uid':
                                        'src/pages/processos/ProcessoDetalhesPage.tsx:343:25',
                                      'data-prohibitions': '[editContent]',
                                      value: o.id,
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                            ...
                            children: isSuggesting
                              ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                  ...
                                  children: [
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, {
                                      'data-uid':
                                        'src/pages/processos/ProcessoDetalhesPage.tsx:355:25',
                                      'data-prohibitions': '[editContent]',
                              ...
                              : suggestedSupervisorId
                                ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                    'data-uid':
                                      'src/pages/processos/ProcessoDetalhesPage.tsx:359:23',
                                    'data-prohibitions': '[editContent]',
                                    className: 'flex flex-col gap-2',
                                    children: [
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('p', {
                                        'data-uid':
                                          'src/pages/processos/ProcessoDetalhesPage.tsx:360:25',
                                        'data-prohibitions': '[editContent]',
                                        className:
                                        ...
                                        children: [
                                          'Supervisor sugerido:',
                                          ' ',
                                          supervisores.find((u) => u.id === suggestedSupervisorId)
                                            ?.name || 'Desconhecido',
                                        ],
                                      }),
                                      formData.supervisor_id !== suggestedSupervisorId &&
                                        ...
                                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                                          'data-uid':
                                            'src/pages/processos/ProcessoDetalhesPage.tsx:366:27',
                                          'data-prohibitions': '[]',
                                          type: 'button',
                                          variant: 'outline',
                                          size: 'sm',
                                          ...
                                          onClick: () =>
                                            handleChange('supervisor_id', suggestedSupervisorId),
                                ...
                                : warningSupervisor
                                  ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                                      'data-uid':
                                        'src/pages/processos/ProcessoDetalhesPage.tsx:378:23',
                                      'data-prohibitions': '[editContent]',
                                      className:
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AlertDialog, {
              ...
              'data-prohibitions': '[]',
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlertDialogTrigger, {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                    ...
                    variant: 'destructive',
                    className:
                      'h-10 w-full sm:w-auto active:scale-[0.98] transition-transform duration-100 bg-brand-coral hover:bg-brand-coral/90 text-white',
                    children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
              ...
              variant: 'outline',
              className:
                'h-10 w-full sm:w-auto active:scale-[0.98] transition-transform duration-100 border-brand-teal text-brand-navy dark:text-white',
              onClick: () => navigate(-1),
              children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
              ...
              'data-prohibitions': '[]',
              className:
                'h-10 w-full sm:w-auto active:scale-[0.98] transition-transform duration-100 bg-brand-cyan text-brand-navy hover:bg-brand-cyan/90 font-bold',
              onClick: handleSave,
              children: [
