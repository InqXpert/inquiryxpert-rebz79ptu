...
import { O as useRealtime, a as Card } from './index-DJeO_T7s.js'
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
            ...
            'data-prohibitions': '[editContent]',
            className:
              'bg-card rounded-lg p-4 shadow-sm flex flex-col items-center justify-center gap-2 min-h-24 transition-all duration-200 hover:shadow-md hover:scale-105 border-border',
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                ...
                'data-prohibitions': '[]',
                className:
                  'text-sm font-semibold text-muted-foreground uppercase tracking-widest text-center',
                children: 'EM ANALISE',
              }),
              loading
...
//# sourceMappingURL=WorkloadCards-C8IzVDuN.js.map
