...
import { W as useNavigate, i as Input, j as Button, n as useToast, q as __vitePreload, z as ErrorBoundary } from "./index-DKRwG9z3.js";
import { t as Skeleton } from "./skeleton-BRUhq-6q.js";
import { t as useAlertas } from "./useAlertas-BF1OmACp.js";
...
import { a as DialogHeader, n as DialogContent, o as DialogTitle, r as DialogDescription, t as Dialog } from "./dialog-1lSq_caN.js";
import { t as Label } from "./label-uRwtRWbt.js";
import { t as useDebounce } from "./use-debounce-MC9AH1lI.js";
import { b as softDeleteProcesso, d as filterByDate, g as getTagColor, i as createAuditLog, l as fetchProcessos, m as filterByStatus, n as calculateDayColor, r as calculateTags, t as batchSoftDeleteProcessos, y as searchProcessos } from "./processosService-B3Pud_mV.js";
import { t as Textarea } from "./textarea-Csb9IlT6.js";
...
function ProcessosListTable({ processos, loading, hasMore, onLoadMore, rawCount, selectedIds, setSelectedIds, canDelete }) {
	...
	const handleSelect = (id, idx, shiftKey) => {
		...
		if (newSelected.length > 100) {
			...
			__vitePreload(() => import("./dist-BcVllSEo.js").then((m) => m.toast.warning("Limite de 100 processos selecionados atingido.")), __vite__mapDeps([0,1,2,3]));
		}
...
function Processos() {
	...
	useRealtime("registros_auditoria_adm", (e) => {
		if (e.action === "create" && e.record.executor_id !== user?.id && user?.role === "c-level") __vitePreload(() => import("./dist-BcVllSEo.js").then((m) => m.toast.info(`Ação administrativa: ${e.record.acao}`, { description: e.record.motivo })), __vite__mapDeps([0,1,2,3]));
	}, user?.role === "c-level");
...
//# sourceMappingURL=Processos-xP3l_GCc.js.map