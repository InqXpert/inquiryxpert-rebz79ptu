...
import { n as isAfter, r as Calendar, t as Calendar$1 } from './calendar-DuV7KqlJ.js'
...
import { V as Link, n as useToast, u as useHubPage } from './index-DJeO_T7s.js'
      ...
      try {
        ...
        setProcesses(
          await pb
            ...
            .getFullList({ filter: `agente_id.user_id = "${userId}" || user_id = "${userId}"` }),
        )
      } catch (error) {
...
var InteractiveCalendar = (0, import_react.memo)(function InteractiveCalendar() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
    ...
    className:
      'bg-card rounded-lg p-4 shadow-sm border border-border mb-4 transition-all duration-200 ease-in-out hover:shadow-md h-full flex flex-col',
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        'data-uid': 'src/components/InteractiveCalendar.tsx:49:7',
        'data-prohibitions': '[]',
        className:
          'text-lg font-semibold text-foreground flex items-center justify-center gap-2 mb-4 shrink-0',
        children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
        ...
        'data-prohibitions': '[editContent]',
        className: 'flex justify-center min-h-[300px] shrink-0',
        children:
          loading && processes.length === 0
            ...
            : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Calendar$1, {
                ...
                classNames: {
                  ...
                  head_cell:
                    'text-muted-foreground rounded-md w-8 font-semibold text-xs text-center',
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        'data-uid': 'src/components/InteractiveCalendar.tsx:116:7',
        'data-prohibitions': '[editContent]',
        className: 'pt-4 border-t border-border overflow-y-auto mt-2 flex-1',
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('h4', {
            'data-uid': 'src/components/InteractiveCalendar.tsx:117:9',
            'data-prohibitions': '[editContent]',
            className: 'text-xs font-semibold text-muted-foreground mb-3 uppercase tracking-wider',
            children: localDate
              ? `Processos para ${format(localDate, 'dd/MM')}`
              : 'Selecione uma data',
          }),
          dateProcesses.length === 0
            ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                'data-uid': 'src/components/InteractiveCalendar.tsx:121:11',
                'data-prohibitions': '[]',
                className: 'text-sm text-muted-foreground/80 py-2 text-center',
                children: 'Nenhum prazo neste dia.',
              })
            : /* @__PURE__ */ (0, import_jsx_runtime.jsx)('ul', {
                'data-uid': 'src/components/InteractiveCalendar.tsx:125:11',
                'data-prohibitions': '[editContent]',
                className: 'space-y-2',
                children: dateProcesses.map((p) =>
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    'li',
                    {
                      'data-uid': 'src/components/InteractiveCalendar.tsx:127:15',
                      'data-prohibitions': '[editContent]',
                      className:
                        'text-sm flex flex-col gap-1 bg-background p-2.5 rounded-md border border-border shadow-sm hover:border-primary/30 transition-all duration-200 ease-in-out',
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
                          'data-uid': 'src/components/InteractiveCalendar.tsx:131:17',
                          'data-prohibitions': '[editContent]',
                          to: `/processos/${p.id}`,
                          className:
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                          'data-uid': 'src/components/InteractiveCalendar.tsx:137:17',
                          'data-prohibitions': '[editContent]',
...
//# sourceMappingURL=InteractiveCalendar-DbvTwTq5.js.map
