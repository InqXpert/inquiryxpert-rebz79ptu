...
import { t as CircleX } from './circle-x-D4GetNkj.js'
...
import { t as Receipt } from './receipt-ifVwqgC2.js'
import { t as Trash2 } from './trash-2-CiM-Iwlb.js'
...
function FileUploadZone({ processoId, agenteId }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
    ...
    className:
      'w-full min-h-[400px] border border-border bg-card rounded-xl flex flex-col overflow-hidden shadow-sm',
    children: [
          ...
          !selectedFile
            ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                    ...
                    'data-prohibitions': '[]',
                    className:
                      'w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center text-primary mb-4 group-hover:scale-110 transition-transform',
            ...
            : /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                  ...
                  'data-prohibitions': '[editContent]',
                  className:
                    'w-full p-4 rounded-xl border border-border bg-muted/10 space-y-4 shadow-sm',
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                          ...
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                              'data-uid':
                                'src/pages/processos/components/FileUploadZone.tsx:173:19',
                              'data-prohibitions': '[]',
                              className:
                                'w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center text-primary shrink-0',
                              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(File, {
                                'data-uid':
                                  'src/pages/processos/components/FileUploadZone.tsx:174:21',
                                'data-prohibitions': '[editContent]',
                                className: 'w-5 h-5',
                              }),
                            }),
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                              'data-uid':
                                'src/pages/processos/components/FileUploadZone.tsx:176:19',
                              'data-prohibitions': '[editContent]',
                              className: 'overflow-hidden',
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                                  'data-uid':
                                    'src/pages/processos/components/FileUploadZone.tsx:177:21',
                                  'data-prohibitions': '[editContent]',
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('p', {
                                  'data-uid':
                                    'src/pages/processos/components/FileUploadZone.tsx:183:21',
                                  'data-prohibitions': '[editContent]',
                                  ...
                                  children: [
                                    ...
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                                      'data-uid':
                                        'src/pages/processos/components/FileUploadZone.tsx:185:23',
                                      'data-prohibitions': '[editContent]',
                        ...
                        !isUploading &&
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                            ...
                            className:
                              'shrink-0 h-8 w-8 text-muted-foreground hover:text-destructive hover:bg-destructive/10',
                            children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, {
                              'data-uid':
                                'src/pages/processos/components/FileUploadZone.tsx:196:21',
                              'data-prohibitions': '[editContent]',
                              className: 'w-4 h-4',
                            }),
                          }),
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                            ...
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                                'data-uid':
                                  'src/pages/processos/components/FileUploadZone.tsx:204:21',
                                'data-prohibitions': '[]',
                                children: 'Enviando...',
                              }),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('span', {
                                'data-uid':
                                  'src/pages/processos/components/FileUploadZone.tsx:205:21',
                                'data-prohibitions': '[editContent]',
                                children: [progress, '%'],
                              }),
                            ],
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                      ...
                      className:
                        'w-full font-bold bg-primary hover:bg-primary/90 text-primary-foreground h-11',
                            ...
                            import_jsx_runtime.Fragment,
                            {
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, {
                                  'data-uid':
                                    'src/pages/processos/components/FileUploadZone.tsx:218:21',
                                  'data-prohibitions': '[editContent]',
...
function DocumentList({ processoId }) {
  ...
  if (loading)
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
      ...
      'data-prohibitions': '[editContent]',
      className:
        'w-full h-full border border-border bg-card rounded-xl flex flex-col overflow-hidden shadow-sm',
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
  ...
  if (error)
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
      ...
      'data-prohibitions': '[]',
      className:
        'w-full h-full border border-border bg-card rounded-xl flex flex-col items-center justify-center p-6 text-center space-y-4 shadow-sm',
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        ...
        'data-prohibitions': '[editContent]',
        className:
          'px-6 py-4 border-b border-border/50 flex justify-between items-center bg-muted/5',
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('h3', {
        ...
        children:
          arquivos.length === 0
            ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                ...
                'data-prohibitions': '[]',
                className:
                  'flex flex-col items-center justify-center h-full py-16 text-center text-muted-foreground',
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                    'data-uid': 'src/pages/processos/components/DocumentList.tsx:110:13',
                    'data-prohibitions': '[]',
                    className:
                      'w-20 h-20 bg-muted rounded-full flex items-center justify-center mb-4',
...
function FileCard({ arq, onDelete, onView, user }) {
  ...
  const getIcon = () => {
    switch (arq.tipo_arquivo) {
      case 'audio':
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Music, {
      ...
      case 'despesas':
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Receipt, {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
    ...
    'data-prohibitions': '[editContent]',
    className:
      'flex flex-col p-4 border border-border rounded-xl bg-card hover:border-primary/30 transition-colors gap-3 animate-in fade-in zoom-in-95 duration-200 shadow-sm',
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        ...
        children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                        ...
                        'data-prohibitions': '[editContent]',
                        className:
                          'capitalize bg-muted px-1.5 py-0.5 rounded font-medium text-[10px]',
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            ...
            'data-prohibitions': '[editContent]',
            className:
              'flex items-center justify-between sm:justify-end gap-3 w-full sm:w-auto shrink-0',
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
      ...
      arq.status === 'rejeitado' &&
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
          ...
          'data-prohibitions': '[editContent]',
          className:
            'text-xs text-rose-700 bg-rose-50 dark:bg-rose-500/10 p-2.5 rounded-lg mt-1 border border-rose-100 dark:border-rose-900/30',
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('h1', {
                ...
                'data-prohibitions': '[editContent]',
                className:
                  'text-2xl sm:text-[28px] font-bold tracking-tight text-foreground flex items-center gap-3',
                children: [
...
//# sourceMappingURL=Documentos-DX2THGvP.js.map
