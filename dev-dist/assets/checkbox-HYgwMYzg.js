...
import { D as Check, S as useControllableState, T as composeEventHandlers, d as useSize, i as Presence, v as Primitive, w as createContextScope } from "./input-BIP1iyRa.js";
import { C as usePrevious } from "./dialog-Bfak-wPB.js";
...
var TableHeader = import_react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", {
	...
	"data-prohibitions": "[editContent]",
	ref,
	className: cn("[&_tr]:border-b bg-muted/50 border-y border-border", className),
	...props
}));
...
var TableHead = import_react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
	...
	"data-prohibitions": "[editContent]",
	ref,
	className: cn("h-12 px-4 text-left align-middle font-semibold text-[13px] text-muted-foreground uppercase tracking-wider [&:has([role=checkbox])]:pr-0", className),
	...props
}));
...
var TableCell = import_react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
	...
	"data-prohibitions": "[editContent]",
	ref,
	className: cn("p-4 align-middle text-[14px] text-foreground font-medium [&:has([role=checkbox])]:pr-0", className),
	...props
}));
...
var Checkbox = import_react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Checkbox$1, {
	...
	"data-prohibitions": "[editContent]",
	ref,
	className: cn("peer h-4 w-4 shrink-0 rounded-[3px] border border-muted-foreground/40 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-[#00A8B5] data-[state=checked]:border-[#00A8B5] data-[state=checked]:text-white transition-colors", className),
	...props,
...
//# sourceMappingURL=checkbox-HYgwMYzg.js.map