...
import { t as determineSupervisor } from './allocationService-CzvOhKu-.js'
...
var checkPlateDuplicates = async (plates, userId, excludeId) => {
  ...
  try {
    ...
    return (
      await pb.collection('processos_operacionais').getList(1, 5, {
        filter: filterStr,
        sort: '-created',
      })
    ).items.map((r) => ({
...
var checkRelatedInsured = async (nomeSegurado, userId, excludeId) => {
  ...
  try {
    ...
    if (excludeId) filterStr += ` && id != '${excludeId}'`
    return (
      await pb.collection('processos_operacionais').getList(1, 3, {
        filter: filterStr,
        sort: '-created',
      })
    ).items.map((r) => ({
...
var SuggestionCard = ({ item, highlight }) =>
  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
    'data-uid': 'src/components/processos/ValidationIndicators.tsx:12:3',
    'data-prohibitions': '[editContent]',
    className:
      'flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 rounded-md border border-brand-teal/20 bg-brand-light/30 dark:bg-black/10 mt-2',
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
    ...
    children: [
      ...
      validation.duplicates.length > 0 &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
          ...
          children: validation.duplicates.map((d) =>
...
var InsuredValidationUI = ({ validation }) => {
  if (validation.state === 'IDLE' || validation.state === 'TYPING' || validation.state === 'VALID')
    return null
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
              ...
              'data-prohibitions': '[]',
              className:
                'text-xs font-semibold text-brand-gray dark:text-brand-light uppercase tracking-wider mb-1',
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
            ...
            'aria-label': 'Voltar',
            className:
              'min-w-[44px] min-h-[44px] text-brand-gray hover:text-brand-navy dark:text-brand-light dark:hover:text-white',
                    ...
                    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FormItem, {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                          ...
                          children: suggestedSupervisorId
                            ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
...
//# sourceMappingURL=NovoProcessoPage-B5D7n1W2.js.map
