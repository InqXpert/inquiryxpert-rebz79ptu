...
import { b as transcribeAudio } from './processosService-BIhEaTIB.js'
import { t as Textarea } from './textarea-2GCD8k8P.js'
import { r as uploadAudioProcesso } from './gestaoAgentes-Bxyt6pZi.js'
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogHeader, {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogDescription, {
              ...
              'data-prohibitions': '[]',
              children:
                'Para dar andamento ao processo, é necessário anexar a gravação da entrevista com o segurado.',
            }),
          ],
        }),
          ...
          children: [
            !file
              ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                  ...
                  'data-prohibitions': '[]',
                  className:
                    'w-full border-2 border-dashed border-[#2bc8cf] rounded-xl p-8 text-center bg-[#b1dad5]/10 hover:bg-[#b1dad5]/30 transition-colors cursor-pointer',
              ...
              : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                  ...
                  'data-prohibitions': '[editContent]',
                  className:
                    'w-full border border-border rounded-xl p-4 flex items-center justify-between bg-muted/30',
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileHeadphone, {
                          'data-uid':
                            'src/pages/gestao-agentes/components/AudioUploadModal.tsx:123:17',
                          'data-prohibitions': '[editContent]',
                          className: 'w-8 h-8 text-[#282c59] shrink-0',
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                          'data-uid':
                            'src/pages/gestao-agentes/components/AudioUploadModal.tsx:124:17',
                          'data-prohibitions': '[editContent]',
                          className: 'min-w-0',
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                              'data-uid':
                                'src/pages/gestao-agentes/components/AudioUploadModal.tsx:125:19',
                              'data-prohibitions': '[editContent]',
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('p', {
                              'data-uid':
                                'src/pages/gestao-agentes/components/AudioUploadModal.tsx:126:19',
                              'data-prohibitions': '[editContent]',
            ...
            errorMsg &&
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                ...
                'data-prohibitions': '[editContent]',
                className:
                  'mt-4 p-3 bg-destructive/10 text-destructive text-sm rounded-lg flex items-start gap-2 w-full',
                children: [
    ...
    children: [
        ...
        children: [
          ...
          isBloqueadoAudio &&
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
              ...
              'data-prohibitions': '[]',
              className:
                'bg-[#f43b53] hover:bg-[#f43b53]/90 text-white rounded-xl h-11 px-6 shadow-md',
      ...
      isBloqueadoAudio &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
          ...
          'data-prohibitions': '[]',
          className:
            'bg-[#f43b53]/10 border border-[#f43b53]/20 rounded-2xl p-6 flex items-start gap-4',
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                  ...
                  children:
                    'Este processo encontra-se bloqueado para faturamento e conclusão final pois não possui o áudio da entrevista. Realize o upload para liberar.',
                }),
              ],
            }),
          ],
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsList, {
                ...
                'data-prohibitions': '[]',
                className:
                  'bg-transparent justify-start w-full border-b-0 h-auto p-0 gap-6 overflow-x-auto',
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsTrigger, {
                    ...
                    value: 'info',
                    className:
                      'data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-[#2bc8cf] rounded-none px-2 py-3 shadow-none text-muted-foreground data-[state=active]:text-[#282c59] text-[15px]',
              ...
              children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                            ...
                            'data-prohibitions': '[editContent]',
                            className: 'font-medium text-[#282c59]',
                            children: processo.data_entrada
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                            ...
                            'data-prohibitions': '[editContent]',
                            className: 'font-medium text-[#282c59]',
                            children: processo.data_prazo
                              ? new Date(processo.data_prazo).toLocaleDateString()
                              : '-',
                          }),
                        ],
                      }),
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                            ...
                            'data-prohibitions': '[editContent]',
                            className:
                              'text-[14px] p-4 bg-amber-50 text-amber-900 rounded-xl mt-1 whitespace-pre-wrap border border-amber-100',
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                            ...
                            variant: 'outline',
                            className:
                              'rounded-xl border-primary text-primary hover:bg-primary/5 shadow-sm',
                            ...
                            children: [
                              isTranscribing
                                ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, {
                                    'data-uid':
                                      'src/pages/gestao-agentes/ProcessoDetail.tsx:238:23',
                                    'data-prohibitions': '[editContent]',
                                    className: 'w-4 h-4 mr-2 animate-spin',
                                  })
                                : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Mic, {
                                    'data-uid':
                                      'src/pages/gestao-agentes/ProcessoDetail.tsx:240:23',
                                    'data-prohibitions': '[editContent]',
                                    className: 'w-4 h-4 mr-2',
                                  }),
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Textarea, {
                        ...
                        className:
                          'min-h-[400px] resize-y rounded-xl text-[15px] p-4 leading-relaxed',
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsContent, {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                    ...
                    'data-prohibitions': '[]',
                    className:
                      'p-12 text-center text-muted-foreground border border-dashed rounded-xl bg-muted/30',
      ...
      processo.status !== 'concluido' &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
          ...
          'data-prohibitions': '[]',
          className:
            'md:hidden fixed bottom-0 left-0 right-0 p-4 bg-background border-t border-border flex gap-3 z-40 shadow-[0_-10px_40px_rgba(0,0,0,0.1)]',
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
              'data-uid': 'src/pages/gestao-agentes/ProcessoDetail.tsx:270:11',
              'data-prohibitions': '[]',
              className:
                'flex-1 h-14 rounded-2xl shadow-md text-[15px] bg-primary/10 text-primary hover:bg-primary/20 border border-primary/20',
              onClick: () => setShowAudioModal(true),
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Mic, {
      ...
      agenteId &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AudioUploadModal, {
...
//# sourceMappingURL=ProcessoDetail-DwfgB_t5.js.map
