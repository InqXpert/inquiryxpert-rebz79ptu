...
import { a as useComposedRefs, o as require_react_dom } from "./dist-qq1kSPKZ.js";
import { r as createLucideIcon } from "./client-riYRmEzR.js";
import { C as createContext2, D as Check, S as useControllableState, T as composeEventHandlers, _ as createCollection, a as Portal$2, b as createSlot, c as Content$1, f as useId, g as useDirection, h as DismissableLayer, i as Presence, l as Root2$1, m as useFocusGuards, n as ReactRemoveScroll, o as Anchor, p as FocusScope, r as hideOthers, s as Arrow, u as createPopperScope, v as Primitive, w as createContextScope } from "./input-CwzicWTw.js";
...
var DialogContent = import_react.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogPortal, {
	...
	children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogOverlay, {
		...
		children: [children, /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Close, {
			...
			"data-prohibitions": "[]",
			className: "absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-brand-cyan/50 focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-brand-light data-[state=open]:text-brand-gray dark:text-white dark:hover:bg-white/10 p-2",
...
//#endregion
export { createDialogScope as C, WarningProvider as S, ChevronDown as T, Overlay as _, SelectValue as a, Title as b, Dialog as c, DialogFooter as d, DialogHeader as f, Description as g, Content as h, SelectTrigger as i, DialogContent as l, Close as m, SelectContent as n, Root as o, DialogTitle as p, SelectItem as r, clamp as s, Select as t, DialogDescription as u, Portal$1 as v, usePrevious as w, Trigger$1 as x, Root$1 as y };

//# sourceMappingURL=select-KbvP0k5Z.js.map