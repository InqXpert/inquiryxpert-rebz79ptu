...
import { a as SelectValue, i as SelectTrigger, n as SelectContent, r as SelectItem, t as Select } from "./select-DAbUQBqP.js";
import { n as FunnelX, t as DoubleConfirmDialog } from "./DoubleConfirmDialog-CVfElJrk.js";
import { t as Inbox } from "./inbox-BQgflhbg.js";
import { t as LoaderCircle } from "./loader-circle-TG0I4Vaq.js";
import { t as MessageSquare } from "./message-square-DaKTrvUm.js";
import { t as Pen } from "./pen-NYHuNOl9.js";
import { t as Plus } from "./plus-DbQGtzhK.js";
import { t as Search } from "./search-ij3E3_5j.js";
import { t as Send } from "./send-VNM6ZGX7.js";
import { t as Trash2 } from "./trash-2-CiE7rZjD.js";
import { n as formatDateBr, t as cn } from "./utils-D0AYOoik.js";
...
import { W as useNavigate, i as Input, j as Button, n as useToast, q as __vitePreload, z as ErrorBoundary } from "./index-b6oNyzHZ.js";
import { t as Skeleton } from "./skeleton-BmOZB-h9.js";
import { t as useAlertas } from "./useAlertas-DH8FpECe.js";
...
import { n as _enum, o as number, s as object } from "./schemas-BNqSdxmF.js";
import { t as ZodIssueCode } from "./compat-DmMZEcT6.js";
import { t as useDebounce } from "./use-debounce-Bhnt2K35.js";
import { S as updateProcesso, a as createAuditLog, d as filterByDate, h as getTagColor, l as fetchProcessos, m as filterByStatus, n as calculateDayColor, r as calculateTags, t as batchSoftDeleteProcessos, v as searchProcessos, y as softDeleteProcesso } from "./processosService-B3v5Ssh5.js";
import { t as Textarea } from "./textarea-BUA6eeYt.js";
import { a as FormLabel, i as FormItem, n as FormControl, o as FormMessage, r as FormField, t as Form } from "./form-BWgamWPe.js";
import { n as RadioGroupItem, t as RadioGroup } from "./radio-group-EEChB0_U.js";
...
function ProcessoTimeline({ processoId }) {
	...
	(0, import_react.useEffect)(() => {
		...
		const fetchData = async () => {
			try {
				const [histRes, auditRes] = await Promise.all([pb.collection("processos_historico").getFullList({
				...
				const combined = [...histRes.map((h) => ({
					...
					} else if (a.acao === "EDITADO") desc = "Registro atualizado no sistema";
					else if (a.acao === "CRIADO") desc = "Processo criado";
					else if (a.acao === "OBSERVACAO_ADICIONADA") desc = "Observação adicionada ao processo";
					else if (a.acao === "POSICAO_ADICIONADA") desc = "Posição atualizada";
					return {
						id: a.id,
	...
	if (loading) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		"data-uid": "src/components/operacional/ProcessoTimeline.tsx:78:7",
		"data-prohibitions": "[]",
		className: "space-y-4 px-2 py-4",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Skeleton, {
			"data-uid": "src/components/operacional/ProcessoTimeline.tsx:79:9",
			"data-prohibitions": "[editContent]",
			className: "h-16 w-full rounded-xl bg-brand-teal/5 dark:bg-brand-cyan/5"
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Skeleton, {
			"data-uid": "src/components/operacional/ProcessoTimeline.tsx:80:9",
			"data-prohibitions": "[editContent]",
			className: "h-16 w-full rounded-xl bg-brand-teal/5 dark:bg-brand-cyan/5"
		})]
	});
	if (historico.length === 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		"data-uid": "src/components/operacional/ProcessoTimeline.tsx:87:7",
		"data-prohibitions": "[]",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		"data-uid": "src/components/operacional/ProcessoTimeline.tsx:94:5",
		"data-prohibitions": "[editContent]",
		className: "px-2 py-4 space-y-0",
		children: historico.map((h, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			"data-uid": "src/components/operacional/ProcessoTimeline.tsx:96:9",
			"data-prohibitions": "[editContent]",
			...
			children: [
				i !== historico.length - 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					"data-uid": "src/components/operacional/ProcessoTimeline.tsx:101:13",
					"data-prohibitions": "[editContent]",
					className: "absolute left-[11px] top-7 bottom-0 w-[2px] bg-brand-teal/20 dark:bg-brand-cyan/20"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					"data-uid": "src/components/operacional/ProcessoTimeline.tsx:103:11",
					"data-prohibitions": "[editContent]",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					"data-uid": "src/components/operacional/ProcessoTimeline.tsx:104:11",
					"data-prohibitions": "[editContent]",
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							"data-uid": "src/components/operacional/ProcessoTimeline.tsx:105:13",
							"data-prohibitions": "[editContent]",
							className: "text-[13px] font-bold text-brand-navy dark:text-white mb-1 uppercase tracking-wide",
							children: h.tipo_evento || "Atualização"
						}),
						h.descricao && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							"data-uid": "src/components/operacional/ProcessoTimeline.tsx:109:15",
							"data-prohibitions": "[editContent]",
							className: "text-[13px] text-brand-gray dark:text-brand-light mb-3 leading-relaxed",
							children: h.descricao
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							"data-uid": "src/components/operacional/ProcessoTimeline.tsx:113:13",
							"data-prohibitions": "[editContent]",
							className: "flex justify-between items-center text-[11px]",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								"data-uid": "src/components/operacional/ProcessoTimeline.tsx:114:15",
								"data-prohibitions": "[editContent]",
								...
								"data-uid": "src/components/operacional/ProcessoTimeline.tsx:117:15",
								"data-prohibitions": "[editContent]",
...
function FinalizarProcessoModal({ processo, open, onOpenChange, onSuccess }) {
	...
	(0, import_react.useEffect)(() => {
		if (open && processo) {
			...
			if (processo.agente_id) {
				setLoading(true);
				pb.collection("agentes").getOne(processo.agente_id).then((agente) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
		"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:159:5",
		"data-prohibitions": "[editContent]",
		open,
		onOpenChange: (val) => !saving && onOpenChange(val),
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
			"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:160:7",
			"data-prohibitions": "[editContent]",
			className: "sm:max-w-[500px]",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogHeader, {
				"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:161:9",
				"data-prohibitions": "[editContent]",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogTitle, {
					"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:162:11",
					"data-prohibitions": "[editContent]",
					children: ["Finalizar Processo ", processo?.numero_controle || processo?.id]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogDescription, {
					"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:163:11",
					"data-prohibitions": "[]",
					children: "Preencha os detalhes financeiros e de documentação para finalizar o processo."
				})]
			}), loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:169:11",
				"data-prohibitions": "[]",
				className: "py-8 flex flex-col items-center justify-center",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, {
					"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:170:13",
					"data-prohibitions": "[editContent]",
					className: "w-8 h-8 animate-spin text-primary mb-4"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:171:13",
					"data-prohibitions": "[]",
					className: "text-sm text-muted-foreground",
					children: "Carregando dados do agente..."
				})]
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Form, {
				"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:174:11",
				"data-prohibitions": "[editContent]",
				...form,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
					"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:175:13",
					"data-prohibitions": "[editContent]",
					onSubmit: form.handleSubmit(onSubmit),
					className: "space-y-6",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:176:15",
							"data-prohibitions": "[]",
							className: "grid grid-cols-1 md:grid-cols-2 gap-4",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormField, {
								"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:177:17",
								"data-prohibitions": "[editContent]",
								control: form.control,
								name: "honorario_valor",
								render: ({ field }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FormItem, {
									"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:181:21",
									"data-prohibitions": "[]",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormLabel, {
											"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:182:23",
											"data-prohibitions": "[]",
											children: "Honorário Valor (R$)"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormControl, {
											"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:183:23",
											"data-prohibitions": "[]",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
												"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:184:25",
												"data-prohibitions": "[editContent]",
												type: "number",
												step: "0.01",
												placeholder: "0.00",
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormMessage, {
											"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:195:23",
											"data-prohibitions": "[editContent]"
										})
									]
								})
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormField, {
								"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:200:17",
								"data-prohibitions": "[editContent]",
								control: form.control,
								name: "despesas_valor",
								render: ({ field }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FormItem, {
									"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:204:21",
									"data-prohibitions": "[]",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormLabel, {
											"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:205:23",
											"data-prohibitions": "[]",
											children: "Despesas Valor (R$)"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormControl, {
											"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:206:23",
											"data-prohibitions": "[]",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
												"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:207:25",
												"data-prohibitions": "[editContent]",
												type: "number",
												step: "0.01",
												placeholder: "0.00",
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormMessage, {
											"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:218:23",
											"data-prohibitions": "[editContent]"
										})
									]
								})
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormField, {
							"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:224:15",
							"data-prohibitions": "[editContent]",
							control: form.control,
							name: "despesas_recebidas",
							render: ({ field }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FormItem, {
								"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:228:19",
								"data-prohibitions": "[]",
								className: "space-y-3",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormLabel, {
										"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:229:21",
										"data-prohibitions": "[]",
										children: "Despesas Recebidas?"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormControl, {
										"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:230:21",
										"data-prohibitions": "[]",
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(RadioGroup, {
											"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:231:23",
											"data-prohibitions": "[]",
											onValueChange: field.onChange,
											value: field.value,
											className: "flex items-center space-x-6",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FormItem, {
												"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:236:25",
												"data-prohibitions": "[]",
												className: "flex items-center space-x-2 space-y-0",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormControl, {
													"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:237:27",
													"data-prohibitions": "[]",
													children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RadioGroupItem, {
														"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:238:29",
														"data-prohibitions": "[editContent]",
														value: "SIM"
													})
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormLabel, {
													"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:240:27",
													"data-prohibitions": "[]",
													className: "font-normal cursor-pointer",
													children: "Sim"
												})]
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FormItem, {
												"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:242:25",
												"data-prohibitions": "[]",
												className: "flex items-center space-x-2 space-y-0",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormControl, {
													"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:243:27",
													"data-prohibitions": "[]",
													children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RadioGroupItem, {
														"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:244:29",
														"data-prohibitions": "[editContent]",
														value: "NAO"
													})
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormLabel, {
													"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:246:27",
													"data-prohibitions": "[]",
													className: "font-normal cursor-pointer",
													children: "Não"
												})]
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormMessage, {
										"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:250:21",
										"data-prohibitions": "[editContent]"
									})
								]
							})
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormField, {
							"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:255:15",
							"data-prohibitions": "[editContent]",
							control: form.control,
							name: "gravacoes_recebidas",
							render: ({ field }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FormItem, {
								"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:259:19",
								"data-prohibitions": "[]",
								className: "space-y-3",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormLabel, {
										"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:260:21",
										"data-prohibitions": "[]",
										children: "Gravações Recebidas?"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormControl, {
										"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:261:21",
										"data-prohibitions": "[]",
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(RadioGroup, {
											"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:262:23",
											"data-prohibitions": "[]",
											onValueChange: field.onChange,
											value: field.value,
											className: "flex items-center space-x-6",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FormItem, {
												"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:267:25",
												"data-prohibitions": "[]",
												className: "flex items-center space-x-2 space-y-0",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormControl, {
													"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:268:27",
													"data-prohibitions": "[]",
													children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RadioGroupItem, {
														"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:269:29",
														"data-prohibitions": "[editContent]",
														value: "SIM"
													})
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormLabel, {
													"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:271:27",
													"data-prohibitions": "[]",
													className: "font-normal cursor-pointer",
													children: "Sim"
												})]
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FormItem, {
												"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:273:25",
												"data-prohibitions": "[]",
												className: "flex items-center space-x-2 space-y-0",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormControl, {
													"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:274:27",
													"data-prohibitions": "[]",
													children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RadioGroupItem, {
														"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:275:29",
														"data-prohibitions": "[editContent]",
														value: "NAO"
													})
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormLabel, {
													"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:277:27",
													"data-prohibitions": "[]",
													className: "font-normal cursor-pointer",
													children: "Não"
												})]
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormMessage, {
										"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:281:21",
										"data-prohibitions": "[editContent]"
									})
								]
							})
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogFooter, {
							"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:286:15",
							"data-prohibitions": "[editContent]",
							className: "pt-4",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:287:17",
								"data-prohibitions": "[]",
								type: "button",
								variant: "outline",
								...
								"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:295:17",
								"data-prohibitions": "[editContent]",
								type: "submit",
								disabled: saving,
								children: [saving && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, {
									"data-uid": "src/components/operacional/FinalizarProcessoModal.tsx:296:30",
									"data-prohibitions": "[editContent]",
...
function ProcessosTableRowDesktop({ processo: p, index: i, expanded, onToggle, onOpenModal, selected, onSelect, canDelete }) {
	...
	const [localStatus, setLocalStatus] = (0, import_react.useState)(p.status);
	const [isChangingStatus, setIsChangingStatus] = (0, import_react.useState)(false);
	const [finalizarModalOpen, setFinalizarModalOpen] = (0, import_react.useState)(false);
	(0, import_react.useEffect)(() => {
	...
	const handleStatusChange = async (newStatus) => {
		...
		try {
			...
			await createAuditLog(p.id, "STATUS_ALTERADO", user?.id, { status: localStatus }, { status: newStatus });
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableRow, {
			"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:104:7",
			"data-prohibitions": "[editContent]",
			...
			children: [
				canDelete && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
					"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:119:11",
					"data-prohibitions": "[]",
					onClick: (e) => e.stopPropagation(),
					className: "px-4",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Checkbox, {
						"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:120:13",
						"data-prohibitions": "[editContent]",
						checked: selected,
						onClick: onSelect
					})
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
					"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:123:9",
					"data-prohibitions": "[editContent]",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
					"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:129:9",
					"data-prohibitions": "[editContent]",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:130:11",
						"data-prohibitions": "[editContent]",
						className: "flex flex-col gap-1.5 items-start",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:131:13",
							"data-prohibitions": "[editContent]",
							...
							children: [localStatus ? localStatus.replace(/_/g, " ") : "-", p.prioridade && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:137:17",
								"data-prohibitions": "[editContent]",
							...
							"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:152:15",
							"data-prohibitions": "[editContent]",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
					"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:169:9",
					"data-prohibitions": "[editContent]",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
					"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:175:9",
					"data-prohibitions": "[editContent]",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
					"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:181:9",
					"data-prohibitions": "[editContent]",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
					"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:187:9",
					"data-prohibitions": "[editContent]",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
					"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:193:9",
					"data-prohibitions": "[editContent]",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:194:11",
						"data-prohibitions": "[editContent]",
						...
						children: [Array.isArray(p.tags) && p.tags.filter((t) => typeof t === "string" && t.trim() !== "").length > 0 ? p.tags.filter((t) => typeof t === "string" && t.trim() !== "").slice(0, 2).map((tag, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
							"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:201:19",
							"data-prohibitions": "[editContent]",
							...
							"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:213:15",
							"data-prohibitions": "[]",
							...
							"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:217:17",
							"data-prohibitions": "[editContent]",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
					"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:229:9",
					"data-prohibitions": "[editContent]",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
					"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:235:9",
					"data-prohibitions": "[editContent]",
					className: "text-right pr-4",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:236:11",
						"data-prohibitions": "[editContent]",
						className: "flex items-center justify-end gap-2",
						children: [canDelete && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:238:15",
							"data-prohibitions": "[]",
							variant: "ghost",
							size: "icon",
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trash2, {
								"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:248:17",
								"data-prohibitions": "[editContent]",
								className: "w-4 h-4"
							})
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, {
							"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:251:13",
							"data-prohibitions": "[editContent]",
		...
		expanded && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableRow, {
			"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:262:9",
			"data-prohibitions": "[editContent]",
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
				"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:263:11",
				"data-prohibitions": "[editContent]",
				colSpan: canDelete ? 10 : 9,
				className: "p-0 border-t border-brand-teal/10 dark:border-brand-cyan/10",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:267:13",
					"data-prohibitions": "[editContent]",
					className: "p-4 md:p-6 animate-in slide-in-from-top-2 fade-in duration-200",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:269:15",
							"data-prohibitions": "[editContent]",
							className: "bg-brand-light/40 dark:bg-brand-navy/40 p-4 rounded-xl mb-5 border border-brand-teal/10 dark:border-brand-cyan/10",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:270:17",
								"data-prohibitions": "[editContent]",
								className: "grid grid-cols-1 md:grid-cols-3 gap-4",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:271:19",
										"data-prohibitions": "[editContent]",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:272:21",
											"data-prohibitions": "[]",
											className: "text-[10px] font-bold text-brand-gray dark:text-brand-light uppercase tracking-wider block mb-1",
											children: "Nome do Segurado"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:275:21",
											"data-prohibitions": "[editContent]",
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:279:19",
										"data-prohibitions": "[editContent]",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:280:21",
											"data-prohibitions": "[]",
											className: "text-[10px] font-bold text-brand-gray dark:text-brand-light uppercase tracking-wider block mb-1",
											children: "Analista da Seguradora"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:283:21",
											"data-prohibitions": "[editContent]",
											className: "text-[13px] font-bold text-brand-navy dark:text-white",
											children: p.expand?.analista_cliente_id?.nome || p.analista_solicitante || "-"
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:287:19",
										"data-prohibitions": "[editContent]",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:288:21",
											"data-prohibitions": "[]",
											className: "text-[10px] font-bold text-brand-gray dark:text-brand-light uppercase tracking-wider block mb-1",
											children: "Placa / Bem Reclamado"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:291:21",
											"data-prohibitions": "[editContent]",
											className: "text-[13px] font-bold text-brand-navy dark:text-white",
											children: p.placas_veiculos || p.bem_reclamado || "-"
										})]
									})
								]
							})
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:299:15",
							"data-prohibitions": "[editContent]",
							className: "mb-6",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
								"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:300:17",
								"data-prohibitions": "[]",
								className: "text-[12px] font-bold text-brand-gray dark:text-brand-light mb-3 ml-1 uppercase tracking-wider",
								children: "Alterar Status"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:303:17",
								"data-prohibitions": "[editContent]",
								...
								children: [
									...
									return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
										"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:313:23",
										"data-prohibitions": "[editContent]",
										size: "sm",
										variant: isActive ? "default" : "outline",
										className: cn("text-[11px] font-bold h-8 transition-colors", isActive ? "bg-brand-teal text-white dark:bg-brand-cyan dark:text-brand-navy hover:bg-brand-teal/90 dark:hover:bg-brand-cyan/90 border-transparent shadow-sm pointer-events-none" : "border-brand-teal/20 dark:border-brand-cyan/20 text-brand-navy dark:text-white bg-white dark:bg-brand-navy hover:bg-brand-teal/10 dark:hover:bg-brand-cyan/10"),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:336:15",
							"data-prohibitions": "[]",
							className: "flex flex-wrap gap-3 mb-6",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
									"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:337:17",
									"data-prohibitions": "[]",
									size: "sm",
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pen, {
										"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:345:19",
										"data-prohibitions": "[editContent]",
										className: "w-4 h-4 mr-2"
									}), " Editar Processo"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
									"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:347:17",
									"data-prohibitions": "[]",
									variant: "secondary",
									size: "sm",
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Send, {
										"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:359:19",
										"data-prohibitions": "[editContent]",
										className: "w-4 h-4 sm:mr-2"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:360:19",
										"data-prohibitions": "[]",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
									"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:363:17",
									"data-prohibitions": "[]",
									variant: "outline",
									size: "sm",
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageSquare, {
										"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:372:19",
										"data-prohibitions": "[editContent]",
										className: "w-4 h-4 mr-2"
									}), " Observações"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
									"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:374:17",
									"data-prohibitions": "[]",
									variant: "outline",
									size: "sm",
									className: "border-brand-teal/20 dark:border-brand-cyan/20 font-bold text-brand-navy dark:text-white bg-white dark:bg-brand-navy min-h-[44px]",
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Flag, {
										"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:383:19",
										"data-prohibitions": "[editContent]",
										className: "w-4 h-4 mr-2"
									}), " Posições"]
								})
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
							"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:386:15",
							"data-prohibitions": "[]",
							className: "text-[14px] font-bold text-brand-navy dark:text-white mb-3 ml-2",
							children: "Linha do Tempo de Atividades"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:389:15",
							"data-prohibitions": "[]",
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProcessoTimeline, {
								"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:390:17",
								"data-prohibitions": "[editContent]",
								processoId: p.id
							})
						})
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DoubleConfirmDialog, {
			"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:397:7",
			"data-prohibitions": "[editContent]",
			open: deleteOpen,
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FinalizarProcessoModal, {
			"data-uid": "src/components/operacional/ProcessosTableRowDesktop.tsx:404:7",
			"data-prohibitions": "[editContent]",
			processo: p,
...
function ProcessosTableRowMobile({ processo: p, index: i, expanded, onToggle, onOpenModal, selected, onSelect, canDelete }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:96:5",
		"data-prohibitions": "[editContent]",
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:110:7",
				"data-prohibitions": "[editContent]",
				className: "flex justify-between items-start mb-3 pr-8",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:111:9",
					"data-prohibitions": "[editContent]",
					className: "flex items-center gap-3",
					children: [canDelete && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:113:13",
						"data-prohibitions": "[]",
						onClick: (e) => e.stopPropagation(),
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Checkbox, {
							"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:114:15",
							"data-prohibitions": "[editContent]",
							checked: selected,
							onClick: onSelect
						})
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:117:11",
						"data-prohibitions": "[editContent]",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:118:13",
							"data-prohibitions": "[editContent]",
							className: "font-bold text-brand-navy dark:text-white text-sm mb-1",
							children: p.numero_controle || p.id || "-"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:121:13",
							"data-prohibitions": "[editContent]",
							className: "font-bold text-xs uppercase text-brand-gray dark:text-brand-light",
							children: localStatus ? localStatus.replace(/_/g, " ") : "-"
						})]
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:126:9",
					"data-prohibitions": "[editContent]",
					className: "flex flex-col items-end gap-2",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:127:11",
						"data-prohibitions": "[editContent]",
			...
			canDelete && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trash2, {
						"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:150:13",
						"data-prohibitions": "[editContent]",
						className: "w-4 h-4"
					})
				})
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:155:7",
				"data-prohibitions": "[editContent]",
				className: "space-y-1 mb-3 text-sm",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:156:9",
						"data-prohibitions": "[editContent]",
						className: "flex justify-between",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:157:11",
							"data-prohibitions": "[]",
							className: "text-brand-gray dark:text-brand-light",
							children: "Seguradora:"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:158:11",
							"data-prohibitions": "[editContent]",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:162:9",
						"data-prohibitions": "[editContent]",
						className: "flex justify-between",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:163:11",
							"data-prohibitions": "[]",
							className: "text-brand-gray dark:text-brand-light",
							children: "Tipo:"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:164:11",
							"data-prohibitions": "[editContent]",
							className: "font-medium text-brand-navy dark:text-white truncate max-w-[180px]",
							children: p.tipo_servico || "-"
						})]
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:168:9",
						"data-prohibitions": "[editContent]",
						className: "flex justify-between",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:169:11",
							"data-prohibitions": "[]",
							className: "text-brand-gray dark:text-brand-light",
							children: "Supervisor:"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:170:11",
							"data-prohibitions": "[editContent]",
							className: "font-medium text-brand-navy dark:text-white truncate max-w-[180px]",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:174:9",
						"data-prohibitions": "[editContent]",
						className: "flex justify-between",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:175:11",
							"data-prohibitions": "[]",
							className: "text-brand-gray dark:text-brand-light",
							children: "Prestador:"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:176:11",
							"data-prohibitions": "[editContent]",
							className: "font-medium text-brand-navy dark:text-white truncate max-w-[180px]",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:180:9",
						"data-prohibitions": "[editContent]",
						className: "flex justify-between",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:181:11",
							"data-prohibitions": "[]",
							className: "text-brand-gray dark:text-brand-light",
							children: "Prioridade:"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			(tags.length > 0 || Array.isArray(p.tags) && p.tags.filter((t) => typeof t === "string" && t.trim() !== "").length > 0) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:191:9",
				"data-prohibitions": "[editContent]",
				...
				children: [tags.map((t, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:204:17",
					"data-prohibitions": "[editContent]",
			...
			expanded && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:215:9",
				"data-prohibitions": "[editContent]",
				className: "mt-4 pt-4 border-t border-brand-teal/10 dark:border-brand-cyan/10 animate-in fade-in slide-in-from-top-2",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:217:11",
						"data-prohibitions": "[editContent]",
						className: "bg-brand-light/40 dark:bg-brand-navy/40 p-4 rounded-xl mb-4 border border-brand-teal/10 dark:border-brand-cyan/10 flex flex-col gap-3",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:218:13",
								"data-prohibitions": "[editContent]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:219:15",
									"data-prohibitions": "[]",
									className: "text-[10px] font-bold text-brand-gray dark:text-brand-light uppercase tracking-wider block mb-1",
									children: "Nome do Segurado"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:222:15",
									"data-prohibitions": "[editContent]",
									className: "text-[13px] font-bold text-brand-navy dark:text-white",
									children: p.nome_segurado || "-"
								})]
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:226:13",
								"data-prohibitions": "[editContent]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:227:15",
									"data-prohibitions": "[]",
									className: "text-[10px] font-bold text-brand-gray dark:text-brand-light uppercase tracking-wider block mb-1",
									children: "Analista da Seguradora"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:230:15",
									"data-prohibitions": "[editContent]",
									className: "text-[13px] font-bold text-brand-navy dark:text-white",
									children: p.expand?.analista_cliente_id?.nome || p.analista_solicitante || "-"
								})]
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:234:13",
								"data-prohibitions": "[editContent]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:235:15",
									"data-prohibitions": "[]",
									className: "text-[10px] font-bold text-brand-gray dark:text-brand-light uppercase tracking-wider block mb-1",
									children: "Placa / Bem Reclamado"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:238:15",
									"data-prohibitions": "[editContent]",
									className: "text-[13px] font-bold text-brand-navy dark:text-white",
									children: p.placas_veiculos || p.bem_reclamado || "-"
								})]
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:245:11",
						"data-prohibitions": "[editContent]",
						className: "mb-5",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
							"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:246:13",
							"data-prohibitions": "[]",
							className: "text-[12px] font-bold text-brand-gray dark:text-brand-light mb-2 uppercase tracking-wider",
							children: "Alterar Status"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:249:13",
							"data-prohibitions": "[editContent]",
							className: "flex flex-wrap gap-2",
							children: [
								"EM EXECUÇÃO",
								...
								const isActive = localStatus?.toUpperCase() === status.toUpperCase();
								return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
									"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:254:21",
									"data-prohibitions": "[editContent]",
									size: "sm",
									variant: isActive ? "default" : "outline",
									className: cn("text-[11px] font-bold h-8 transition-colors flex-1 min-w-[120px]", isActive ? "bg-brand-teal text-white dark:bg-brand-cyan dark:text-brand-navy border-transparent shadow-sm pointer-events-none" : "border-brand-teal/20 dark:border-brand-cyan/20 text-brand-navy dark:text-white bg-white dark:bg-brand-navy hover:bg-brand-teal/10 dark:hover:bg-brand-cyan/10"),
									disabled: isActive || isChangingStatus,
									onClick: (e) => {
										e.stopPropagation();
										handleStatusChange(status);
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:278:11",
						"data-prohibitions": "[]",
						className: "flex flex-col gap-2 mb-4",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
								"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:279:13",
								"data-prohibitions": "[]",
								size: "sm",
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pen, {
									"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:287:15",
									"data-prohibitions": "[editContent]",
									className: "w-4 h-4 mr-2"
								}), " Editar Processo"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
								"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:289:13",
								"data-prohibitions": "[]",
								variant: "outline",
								size: "sm",
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageSquare, {
									"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:298:15",
									"data-prohibitions": "[editContent]",
									className: "w-4 h-4 mr-2"
								}), " Obs"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
								"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:300:13",
								"data-prohibitions": "[]",
								variant: "outline",
								size: "sm",
								className: "w-full bg-white dark:bg-brand-navy border-brand-teal/20 dark:border-brand-cyan/20 min-h-[44px]",
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Flag, {
									"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:309:15",
									"data-prohibitions": "[editContent]",
									className: "w-4 h-4 mr-2"
								}), " Posições"]
							})
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
						"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:312:11",
						"data-prohibitions": "[]",
						className: "text-[13px] font-bold text-brand-navy dark:text-white mb-3",
						children: "Linha do Tempo"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:315:11",
						"data-prohibitions": "[]",
						className: "bg-brand-light/30 dark:bg-black/20 rounded-xl p-1 border border-brand-teal/10 dark:border-brand-cyan/10",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProcessoTimeline, {
							"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:316:13",
							"data-prohibitions": "[editContent]",
							processoId: p.id
						})
					})
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DoubleConfirmDialog, {
				"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:321:7",
				"data-prohibitions": "[editContent]",
				open: deleteOpen,
				onOpenChange: setDeleteOpen,
				title: "Deletar Processo",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FinalizarProcessoModal, {
				"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:329:7",
				"data-prohibitions": "[editContent]",
				processo: p,
				open: finalizarModalOpen,
				onOpenChange: setFinalizarModalOpen,
...
function ProcessosListTable({ processos, loading, hasMore, onLoadMore, rawCount, selectedIds, setSelectedIds, canDelete }) {
	...
	const handleSelect = (id, idx, shiftKey) => {
		...
		if (newSelected.length > 100) {
			...
			__vitePreload(() => import("./dist-DlnX8pNU.js").then((m) => m.toast.warning("Limite de 100 processos selecionados atingido.")), __vite__mapDeps([0,1,2,3]));
		}
...
function Processos() {
	...
	useRealtime("registros_auditoria_adm", (e) => {
		if (e.action === "create" && e.record.executor_id !== user?.id && user?.role === "c-level") __vitePreload(() => import("./dist-DlnX8pNU.js").then((m) => m.toast.info(`Ação administrativa: ${e.record.acao}`, { description: e.record.motivo })), __vite__mapDeps([0,1,2,3]));
	}, user?.role === "c-level");
...
//# sourceMappingURL=Processos-DR7qKLGM.js.map