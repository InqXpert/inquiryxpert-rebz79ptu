...
function NotificacoesPage() {
  ...
  const handleNotificationClick = async (notif) => {
    ...
    if (notif.processo_id)
      if (notif.tipo === 'arquivo_rejeitado') navigate(`/processos/${notif.processo_id}/documentos`)
  ...
  if (loading)
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
      ...
      'data-prohibitions': '[]',
      className:
        'w-full h-full flex flex-col items-center justify-center text-muted-foreground gap-4 py-20',
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
          'data-uid': 'src/pages/Notificacoes.tsx:45:9',
          'data-prohibitions': '[editContent]',
          className:
            'w-8 h-8 rounded-full border-[3px] border-brand-cyan border-t-transparent animate-spin',
        }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
    ...
    'data-prohibitions': '[editContent]',
    className:
      'p-4 md:p-6 w-full max-w-5xl mx-auto flex flex-col h-full animate-in fade-in duration-300',
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
      ...
      notifications.length === 0
        ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            ...
            'data-prohibitions': '[]',
            className:
              'flex flex-col items-center justify-center py-20 text-muted-foreground bg-white rounded-xl shadow-sm border border-border',
            children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                                ...
                                'data-prohibitions': '[editContent]',
                                className:
                                  'text-[11px] text-slate-500 font-medium whitespace-nowrap bg-slate-100 px-2 py-0.5 rounded',
                                children: format(new Date(notif.created), "dd MMM 'às' HH:mm", {
                                  locale: ptBR,
                                }),
                              }),
                            ],
...
//# sourceMappingURL=Notificacoes-Bib9p1h6.js.map
