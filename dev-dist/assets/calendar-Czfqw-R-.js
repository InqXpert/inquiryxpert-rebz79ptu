...
import { _ as startOfISOWeek, a as format, b as toDate, c as getISOWeek, f as isDate, h as normalizeDates, l as enUS$1, m as startOfDay, p as differenceInCalendarDays, s as getWeek, t as cn, u as startOfYear, v as startOfWeek, x as constructFrom, y as getDefaultOptions } from "./utils-AnflaWTD.js";
import { t as addDays } from "./addDays-sTDcI_2E.js";
import { n as differenceInCalendarMonths, r as addMonths, t as endOfMonth } from "./endOfMonth-CvKvCpqM.js";
import { t as startOfMonth } from "./startOfMonth-CU_vApoS.js";
import { n as buttonVariants, t as Button$1 } from "./button-Bg7Oda7m.js";
...
function Calendar({ className, classNames, showOutsideDays = true, captionLayout = "label", buttonVariant = "ghost", formatters, components, ...props }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DayPicker, {
		...
		classNames: {
			...
			caption_label: cn("select-none font-semibold text-lg text-foreground", captionLayout === "label" ? "" : "[&>svg]:text-muted-foreground flex h-8 items-center gap-1 rounded-md pl-2 pr-1 [&>svg]:size-3.5", defaultClassNames.caption_label),
			table: "w-full border-collapse",
			weekdays: cn("flex", defaultClassNames.weekdays),
			weekday: cn("text-muted-foreground flex-1 select-none rounded-md text-xs font-semibold text-center", defaultClassNames.weekday),
			week: cn("mt-2 flex w-full", defaultClassNames.week),
			week_number_header: cn("w-[--cell-size] select-none", defaultClassNames.week_number_header),
			week_number: cn("text-muted-foreground select-none text-[0.8rem]", defaultClassNames.week_number),
			day: cn("group/day relative flex w-full items-center justify-center select-none p-0 text-center text-sm font-medium text-foreground [&:first-child[data-selected=true]_button]:rounded-full [&:last-child[data-selected=true]_button]:rounded-full", defaultClassNames.day),
...
function CalendarDayButton({ className, day, modifiers, ...props }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button$1, {
		...
		className: cn("data-[selected-single=true]:bg-primary data-[selected-single=true]:text-primary-foreground data-[range-middle=true]:bg-accent data-[range-middle=true]:text-accent-foreground data-[range-start=true]:bg-primary data-[range-start=true]:text-primary-foreground data-[range-end=true]:bg-primary data-[range-end=true]:text-primary-foreground group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-ring/50 flex size-[--cell-size] flex-col gap-1 font-medium text-sm leading-none rounded-md hover:bg-secondary cursor-pointer group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:ring-[3px] [&>span]:text-xs [&>span]:opacity-70", defaultClassNames.day, className),
		...props
	});
}
//#endregion
export { Calendar$1 as i, isBefore as n, isAfter as r, Calendar as t };

//# sourceMappingURL=calendar-Czfqw-R-.js.map