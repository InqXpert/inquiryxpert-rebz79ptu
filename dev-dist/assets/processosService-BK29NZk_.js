...
var getTagColor = (tag) => {
	...
	if (t === "PAGAMENTO AUTORIZADO") return "bg-green-100 text-green-800 border-green-200 dark:bg-green-900/30 dark:text-green-400 dark:border-green-800";
	if (t === "PAGAMENTO NÃO AUTORIZADO") return "bg-red-100 text-red-800 border-red-200 dark:bg-red-900/30 dark:text-red-400 dark:border-red-800";
...
var checkImeiDuplicate = async (imei) => {
	if (!imei) return null;
	try {
		const result = await pb.collection("processos_operacionais").getList(1, 1, {
...
//#endregion
export { validateDuplicidade as C, updateProcesso as S, searchByNumero as _, createAuditLog as a, toggleProcessoFavorite as b, fetchProcessoById as c, filterByDate as d, filterByFavorites as f, markProcessosAsRead as g, getTagColor as h, checkImeiDuplicate as i, fetchProcessos as l, filterByStatus as m, calculateDayColor as n, deleteProcesso as o, filterByPriority as p, calculateTags as r, fetchFavoritos as s, batchSoftDeleteProcessos as t, fetchProcessosAgente as u, searchProcessos as v, transcribeAudio as x, softDeleteProcesso as y };

//# sourceMappingURL=processosService-BK29NZk_.js.map