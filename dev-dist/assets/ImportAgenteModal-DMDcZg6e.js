...
import { A as Button, U as useNavigate, t as toast } from './index-BP6ztLFk.js'
import { n as utils, r as writeFileSync, t as readSync } from './xlsx-B_AR_fcR.js'
import {
  a as DialogHeader,
  i as DialogFooter,
  n as DialogContent,
          ...
          children: [
            ...
            file
              ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                  ...
                  'data-prohibitions': '[editContent]',
                  className:
                    'border-2 border-dashed border-secondary bg-secondary/5 rounded-2xl p-6 text-center transition-colors duration-200',
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                      'data-uid': 'src/components/agentes/ImportAgenteModal.tsx:149:15',
                      'data-prohibitions': '[editContent]',
                      className:
                        'flex flex-row justify-between items-center bg-background p-4 rounded-xl border border-border shadow-sm',
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                          ...
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                              ...
                              'data-prohibitions': '[]',
                              className:
                                'w-10 h-10 rounded-lg bg-secondary/10 flex items-center justify-center shrink-0',
                    ...
                    status === 'loading'
                      ...
                      : analysis
                        ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                            ...
                            'data-prohibitions': '[editContent]',
                            className:
                              'mt-6 text-left bg-background p-5 rounded-xl border border-border/50 shadow-sm',
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                ...
                                children: [
                                  analysis.matched.length > 0 &&
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                      'data-uid':
                                        'src/components/agentes/ImportAgenteModal.tsx:189:23',
                                      'data-prohibitions': '[editContent]',
                                      className: 'flex flex-row gap-3 items-start',
                                      children: [
                                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, {
                                          'data-uid':
                                            'src/components/agentes/ImportAgenteModal.tsx:190:25',
                                          'data-prohibitions': '[editContent]',
                                          className: 'w-5 h-5 text-secondary shrink-0 mt-0.5',
                                        }),
                                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('span', {
                                          'data-uid':
                                            'src/components/agentes/ImportAgenteModal.tsx:191:25',
                                          'data-prohibitions': '[editContent]',
                                          className: 'text-[14px] text-foreground',
                                          children: [
                                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('strong', {
                                              'data-uid':
                                                'src/components/agentes/ImportAgenteModal.tsx:192:27',
                                              'data-prohibitions': '[editContent]',
                                  ...
                                  analysis.missing.length > 0 &&
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                      'data-uid':
                                        'src/components/agentes/ImportAgenteModal.tsx:197:23',
                                      'data-prohibitions': '[editContent]',
                                      className: 'flex flex-row gap-3 items-start',
                                      children: [
                                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TriangleAlert, {
                                          'data-uid':
                                            'src/components/agentes/ImportAgenteModal.tsx:198:25',
                                          'data-prohibitions': '[editContent]',
                                          className: 'w-5 h-5 text-yellow-600 shrink-0 mt-0.5',
                                        }),
                                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('span', {
                                          'data-uid':
                                            'src/components/agentes/ImportAgenteModal.tsx:199:25',
                                          'data-prohibitions': '[editContent]',
                                          className:
                                  ...
                                  analysis.unmatched.length > 0 &&
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                      'data-uid':
                                        'src/components/agentes/ImportAgenteModal.tsx:205:23',
                                      'data-prohibitions': '[editContent]',
                                      className: 'flex flex-row gap-3 items-start',
                                      children: [
                                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TriangleAlert, {
                                          'data-uid':
                                            'src/components/agentes/ImportAgenteModal.tsx:206:25',
                                          'data-prohibitions': '[editContent]',
                                          className: 'w-5 h-5 text-blue-500 shrink-0 mt-0.5',
                                        }),
                                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('span', {
                                          'data-uid':
                                            'src/components/agentes/ImportAgenteModal.tsx:207:25',
                                          'data-prohibitions': '[editContent]',
                                          className:
                                            'text-[14px] text-muted-foreground font-medium',
                                          children: [
                                            'Extras (nas observações): ',
                                            analysis.unmatched.join(', '),
                                          ],
                                        }),
                                      ],
                                    }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('button', {
                ...
                className:
                  'text-[14px] text-primary hover:text-primary/80 hover:underline font-bold flex flex-row gap-2 items-center px-1 rounded-md transition-colors',
                children: [
...
//# sourceMappingURL=ImportAgenteModal-DMDcZg6e.js.map
