...
var calculateTags = (dataEntradaStr) => {
	...
	if (business >= 3) tags.push({
		...
		color: "bg-[hsl(45,96%,56%)] text-black"
	});
	if (calendar >= 5) tags.push({
		label: "Atualização",
		color: "bg-[hsl(25,95%,53%)] text-white"
	});
...
//#endregion
export { fetchProcessosAgente as a, filterByPriority as c, searchByNumero as d, searchProcessos as f, fetchProcessos as i, filterByStatus as l, transcribeAudio as m, calculateTags as n, filterByDate as o, toggleProcessoFavorite as p, fetchFavoritos as r, filterByFavorites as s, calculateDayColor as t, markProcessosAsRead as u };

//# sourceMappingURL=processosService-Buzyszge.js.map