...
import { W as useNavigate, i as Input, j as Button, n as useToast, q as __vitePreload, z as ErrorBoundary } from "./index-CdkCWQL-.js";
...
import { a as DialogHeader, n as DialogContent, o as DialogTitle, r as DialogDescription, t as Dialog } from "./dialog-BZGNj0t6.js";
...
function ProcessosListTable({ processos, loading, hasMore, onLoadMore, rawCount, selectedIds, setSelectedIds, canDelete }) {
	...
	const handleSelect = (id, idx, shiftKey) => {
		...
		if (newSelected.length > 100) {
			...
			__vitePreload(() => import("./dist-CRVa_c9e.js").then((m) => m.toast.warning("Limite de 100 processos selecionados atingido.")), __vite__mapDeps([0,1,2,3]));
		}
...
function Processos() {
	...
	useRealtime("registros_auditoria_adm", (e) => {
		if (e.action === "create" && e.record.executor_id !== user?.id && user?.role === "c-level") __vitePreload(() => import("./dist-CRVa_c9e.js").then((m) => m.toast.info(`Ação administrativa: ${e.record.acao}`, { description: e.record.motivo })), __vite__mapDeps([0,1,2,3]));
	}, user?.role === "c-level");
...
//# sourceMappingURL=Processos-C4cgh1g6.js.map