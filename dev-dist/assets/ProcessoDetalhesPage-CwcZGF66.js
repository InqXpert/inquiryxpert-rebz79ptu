...
import { t as Info } from './info-DDwbsJOu.js'
...
import { t as useDirection } from './dist-CEUYTUCg.js'
...
import {
  ...
  K as useParams,
  M as Button,
  b as createRovingFocusGroupScope,
  d as toast,
  v as Item,
  y as Root,
...
import './processosService-Qd6lQUDQ.js'
import {
  ...
  t as AlertDialog,
} from './alert-dialog-LR7IqUsw.js'
import { t as useProcessoDetalhes } from './useProcessoDetalhes-CX_4fpka.js'
...
async function getPeriodoFaturamentoProcesso(clienteId, dataSaidaStr) {
  ...
  try {
    const periodos = await pb
      .collection('periodos_faturamento')
      .getFullList({
...
var STATUSES = ['ANALISE_INICIAL', 'EM_EXECUCAO', 'EM_ELABORACAO', 'FINALIZADO', 'CANCELADO']
function ProcessoDetalhesPage() {
  ...
  const handleConcluir = async () => {
    ...
    try {
      if (
        (await pb.send(`/backend/v1/processos/${processo.id}/check-completion`, { method: 'POST' }))
          .can_conclude
      ) {
        await save(
          {
  ...
  if (loading)
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
      'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:144:7',
      'data-prohibitions': '[]',
      className: 'p-6 space-y-6',
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Skeleton, {
          'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:145:9',
          'data-prohibitions': '[editContent]',
          className: 'h-10 w-1/3',
        }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Skeleton, {
          'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:146:9',
          'data-prohibitions': '[editContent]',
          className: 'h-[200px]',
        }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Skeleton, {
          'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:147:9',
          'data-prohibitions': '[editContent]',
          className: 'h-[400px]',
        }),
      ],
  ...
  const InfoItem = ({ label, value }) =>
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
      'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:166:5',
      'data-prohibitions': '[editContent]',
      className:
        'flex flex-col space-y-1 bg-brand-light/30 dark:bg-black/10 p-3 rounded-[6px] border border-brand-teal/10 dark:border-brand-cyan/10',
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
          'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:167:7',
          'data-prohibitions': '[editContent]',
          className:
            'text-xs font-bold text-brand-gray dark:text-brand-light uppercase tracking-wider',
          children: label,
        }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
          'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:170:7',
          'data-prohibitions': '[editContent]',
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
    'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:177:5',
    'data-prohibitions': '[editContent]',
    className: 'p-6 max-w-5xl mx-auto animate-in fade-in duration-300 fill-mode-both',
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:178:7',
        'data-prohibitions': '[editContent]',
        className:
          'flex flex-col md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-4 mb-6',
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
            'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:179:9',
            'data-prohibitions': '[]',
            variant: 'outline',
            onClick: () => navigate('/processos'),
            className:
              'text-brand-navy dark:text-white h-10 px-4 active:scale-[0.98] transition-transform duration-100 border-brand-teal/20 w-fit',
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowLeft, {
                'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:184:11',
                'data-prohibitions': '[editContent]',
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('h1', {
                'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:187:11',
                'data-prohibitions': '[editContent]',
                className:
                  'text-[24px] sm:text-[28px] font-bold tracking-tight text-brand-navy dark:text-white flex flex-wrap items-center gap-3',
                children: [
                  'Processo ',
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
                    ...
                    variant: 'outline',
                    className:
                      'border-brand-teal/30 text-brand-navy dark:text-brand-light text-sm bg-white dark:bg-brand-navy/50',
                  ...
                  loadingFinanceiro
                    ...
                    : statusFinanceiro
                      ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Badge, {
                          'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:198:15',
                          'data-prohibitions': '[editContent]',
                          variant: 'outline',
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:206:11',
                'data-prohibitions': '[editContent]',
                className: 'flex flex-wrap gap-2',
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                    'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:207:13',
                    'data-prohibitions': '[]',
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                    'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:214:13',
                    'data-prohibitions': '[editContent]',
                    onClick: handleConcluir,
                    disabled: isChecking || processo.status === 'FINALIZADO',
                    className:
                      'bg-brand-cyan text-brand-navy hover:bg-brand-cyan/90 font-bold shadow-sm shrink-0',
                    children: [
                      isChecking
                        ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, {
                            'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:220:17',
                            'data-prohibitions': '[editContent]',
                            className: 'w-4 h-4 mr-2 animate-spin',
                          })
                        : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, {
                            'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:222:17',
                            'data-prohibitions': '[editContent]',
                            className: 'w-4 h-4 mr-2',
                          }),
                      'Concluir Processo',
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:230:7',
        'data-prohibitions': '[editContent]',
        className: 'space-y-6',
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:231:9',
            'data-prohibitions': '[]',
            className:
              'bg-white dark:bg-brand-navy/80 border border-brand-teal/20 dark:border-brand-cyan/20 rounded-xl p-6 shadow-sm animate-in fade-in slide-in-from-bottom-2 duration-300 fill-mode-both delay-100',
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)('h2', {
                    'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:234:13',
                    'data-prohibitions': '[]',
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:238:11',
                'data-prohibitions': '[]',
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InfoItem, {
                    ...
                    label: 'Cliente',
                    value:
                      processo.expand?.cliente_id?.nome ||
                      processo.expand?.cliente_id?.razao_social,
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InfoItem, {
                    'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:243:13',
                    'data-prohibitions': '[editContent]',
                    label: 'Seguradora',
                    value: processo.expand?.seguradora_id?.nome || processo.cia,
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InfoItem, {
                    'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:247:13',
                    'data-prohibitions': '[editContent]',
                    label: 'Natureza do Sinistro',
                    value: processo.expand?.natureza_sinistro_id?.nome || processo.tipo_servico,
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InfoItem, {
                    'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:251:13',
                    'data-prohibitions': '[editContent]',
                    label: 'Tipo de Investigação',
                    value: processo.expand?.tipo_investigacao_id?.nome || processo.orientacoes,
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InfoItem, {
                    'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:255:13',
                    'data-prohibitions': '[editContent]',
                    label: 'Controle Cia',
                    value: processo.controle_cia,
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InfoItem, {
                    'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:256:13',
                    'data-prohibitions': '[editContent]',
                    label: 'Agente',
                    value:
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InfoItem, {
                    'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:264:13',
                    'data-prohibitions': '[editContent]',
                    label: 'Solicitante',
                    value: processo.expand?.solicitante_id?.name || processo.analista_solicitante,
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InfoItem, {
                    'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:268:13',
                    'data-prohibitions': '[editContent]',
                    label: 'Supervisor',
                    value: processo.expand?.supervisor_id?.name,
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InfoItem, {
                    'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:269:13',
                    'data-prohibitions': '[editContent]',
                    label: 'Região do Sinistro',
                    value: processo.regiao_sinistro,
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InfoItem, {
                    'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:270:13',
                    'data-prohibitions': '[editContent]',
                    label: 'Nome do Segurado',
                    value: processo.nome_segurado,
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InfoItem, {
                    'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:271:13',
                    'data-prohibitions': '[editContent]',
                    label: 'Placas dos Veículos',
                    value: processo.placas_veiculos,
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InfoItem, {
                    'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:272:13',
                    'data-prohibitions': '[editContent]',
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:276:9',
            'data-prohibitions': '[editContent]',
            className:
              'bg-white dark:bg-brand-navy/80 border border-brand-teal/20 dark:border-brand-cyan/20 rounded-xl p-6 shadow-sm animate-in fade-in slide-in-from-bottom-2 duration-300 fill-mode-both delay-200',
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('h2', {
                'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:277:11',
                'data-prohibitions': '[]',
                className:
                  'text-[18px] font-bold text-brand-navy dark:text-white mb-6 flex items-center gap-2',
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, {
                    'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:278:13',
                    'data-prohibitions': '[editContent]',
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:281:11',
                'data-prohibitions': '[editContent]',
                className: 'space-y-6 max-w-3xl',
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                    'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:282:13',
                    'data-prohibitions': '[]',
                    className: 'space-y-3',
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
                        'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:283:15',
                        'data-prohibitions': '[]',
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(RadioGroup, {
                        'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:286:15',
                        'data-prohibitions': '[]',
                        value: actionType,
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                            'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:291:17',
                            'data-prohibitions': '[]',
                            className:
                              'flex items-center space-x-2 bg-brand-light/20 dark:bg-black/20 p-3 rounded-lg border border-brand-teal/10 dark:border-brand-cyan/10',
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RadioGroupItem, {
                                'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:292:19',
                                'data-prohibitions': '[editContent]',
                                value: 'MANTER',
                                id: 'manter',
                              }),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
                                'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:293:19',
                                'data-prohibitions': '[]',
                                htmlFor: 'manter',
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                            'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:297:17',
                            'data-prohibitions': '[]',
                            className:
                              'flex items-center space-x-2 bg-brand-light/20 dark:bg-black/20 p-3 rounded-lg border border-brand-teal/10 dark:border-brand-cyan/10',
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RadioGroupItem, {
                                'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:298:19',
                                'data-prohibitions': '[editContent]',
                                value: 'ALTERAR',
                                id: 'alterar',
                              }),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
                                'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:299:19',
                                'data-prohibitions': '[]',
                                htmlFor: 'alterar',
                                className: 'cursor-pointer font-medium',
                  ...
                  actionType === 'ALTERAR' &&
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                      'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:307:15',
                      'data-prohibitions': '[editContent]',
                      className: 'space-y-2 animate-in fade-in slide-in-from-top-2',
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
                          'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:308:17',
                          'data-prohibitions': '[]',
                          className: 'font-bold text-brand-navy dark:text-white',
                          children: 'Novo Status',
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
                          'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:309:17',
                          'data-prohibitions': '[editContent]',
                          value: newStatus,
                          onValueChange: setNewStatus,
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
                              'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:310:19',
                              'data-prohibitions': '[]',
                              className:
                                'w-full sm:w-[300px] border-brand-teal/20 dark:border-brand-cyan/20 focus:ring-brand-cyan',
                              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, {
                                'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:311:21',
                                'data-prohibitions': '[editContent]',
                                placeholder: 'Selecione...',
                              }),
                            }),
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectContent, {
                              'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:313:19',
                              'data-prohibitions': '[editContent]',
                              children: STATUSES.map((s) =>
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                  ...
                                  {
                                    'data-uid':
                                      'src/pages/processos/ProcessoDetalhesPage.tsx:315:23',
                                    'data-prohibitions': '[editContent]',
                                    value: s,
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                    'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:324:13',
                    'data-prohibitions': '[]',
                    className: 'space-y-2',
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
                        'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:325:15',
                        'data-prohibitions': '[]',
                        className: 'font-bold text-brand-navy dark:text-white',
                        children: 'Atualizar Posição',
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('textarea', {
                        'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:326:15',
                        'data-prohibitions': '[editContent]',
                        className:
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                    'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:334:13',
                    'data-prohibitions': '[editContent]',
                    className: 'space-y-2',
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Label, {
                        'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:335:15',
                        'data-prohibitions': '[editContent]',
                        className: 'font-bold text-brand-navy dark:text-white',
                        children: [
                          ...
                          actionType === 'MANTER' &&
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                              'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:337:45',
                              'data-prohibitions': '[]',
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('textarea', {
                        'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:339:15',
                        'data-prohibitions': '[editContent]',
                        className:
                          'flex min-h-[100px] w-full rounded-md border border-brand-teal/20 bg-transparent px-3 py-2 text-sm shadow-sm placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-brand-cyan disabled:cursor-not-allowed disabled:opacity-50 dark:border-brand-cyan/20 dark:text-white resize-y',
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                    'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:347:13',
                    'data-prohibitions': '[editContent]',
                    className: 'pt-4 flex justify-end',
                    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                      'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:348:15',
                      'data-prohibitions': '[editContent]',
                      onClick: handleResolve,
                      disabled: isSubmitting,
                      className:
                        'h-12 px-6 bg-brand-cyan text-brand-navy hover:bg-brand-cyan/90 font-bold text-base w-full sm:w-auto active:scale-[0.98] transition-transform duration-100',
                      children: [
                        isSubmitting
                          ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, {
                              'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:354:19',
                              'data-prohibitions': '[editContent]',
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlertDialog, {
        'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:365:7',
        'data-prohibitions': '[]',
        open: showModal,
        onOpenChange: setShowModal,
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AlertDialogContent, {
          'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:366:9',
          'data-prohibitions': '[]',
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AlertDialogHeader, {
              'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:367:11',
              'data-prohibitions': '[]',
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlertDialogTitle, {
                  'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:368:13',
                  'data-prohibitions': '[]',
                  children: 'Documentos Obrigatórios Faltando',
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlertDialogDescription, {
                  'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:369:13',
                  'data-prohibitions': '[]',
                  children:
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AlertDialogFooter, {
              'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:373:11',
              'data-prohibitions': '[]',
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlertDialogCancel, {
                  'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:374:13',
                  'data-prohibitions': '[]',
                  onClick: () => setShowModal(false),
                  children: 'Cancelar',
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlertDialogAction, {
                  'data-uid': 'src/pages/processos/ProcessoDetalhesPage.tsx:375:13',
                  'data-prohibitions': '[]',
                  onClick: () => {
                    setShowModal(false)
...
//# sourceMappingURL=ProcessoDetalhesPage-CwcZGF66.js.map
