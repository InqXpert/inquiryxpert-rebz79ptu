  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
    ...
    children: [
          ...
          : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
                  ...
                  'data-prohibitions': '[editContent]',
                  className:
                    'hover:shadow-md transition-shadow border bg-white dark:bg-brand-navy/80 dark:border-brand-cyan/20',
                  children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        ...
        'data-prohibitions': '[editContent]',
        className:
          'bg-white dark:bg-brand-navy/80 border border-border dark:border-brand-cyan/20 rounded-xl shadow-sm overflow-hidden',
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('table', {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)('thead', {
                  ...
                  'data-prohibitions': '[]',
                  className:
                    'bg-muted/50 text-muted-foreground border-b border-border dark:border-brand-cyan/20',
                    ...
                    ? Array.from({ length: 5 }).map((_, i) =>
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                          'tr',
                          {
                            ...
                            'data-prohibitions': '[]',
                            className:
                              'border-b last:border-0 border-border dark:border-brand-cyan/10',
                            children: [
                      ...
                      : data.recentes.map((nota) =>
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                            'tr',
                            {
                              ...
                              'data-prohibitions': '[editContent]',
                              className:
                                'border-b border-border dark:border-brand-cyan/10 transition-colors hover:bg-muted/30 even:bg-muted/50 dark:even:bg-black/10',
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)('td', {
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)('td', {
                                  ...
                                  'data-prohibitions': '[editContent]',
                                  className:
                                    'p-4 text-right font-medium text-gray-900 dark:text-gray-100',
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)('td', {
                                  ...
                                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
                                    'data-uid':
                                      'src/pages/financeiro/DashboardFinanceiro.tsx:181:23',
                                    'data-prohibitions': '[editContent]',
                                    variant: 'outline',
...
//# sourceMappingURL=DashboardFinanceiro-Dnn43Vvg.js.map
