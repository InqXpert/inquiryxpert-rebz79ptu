...
import { a as format, b as toDate, i as parseISO, o as addLeadingZeros, r as ptBR, t as cn } from "./utils-EHP8ym4O.js";
import { t as addDays } from "./addDays-DjlYWjJI.js";
import { t as differenceInDays } from "./differenceInDays-CjYThSJh.js";
import { t as startOfMonth } from "./startOfMonth-BomM5Zg-.js";
import { t as subDays } from "./subDays-BREgvDjO.js";
import { t as pb } from "./client-BSTIQdJC.js";
import { B as Bell, E as useAuth, I as LayoutDashboard, P as Search, V as Link, j as Button, u as toast } from "./index-BJDtQWZj.js";
...
function ActionCard({ to, icon: Icon, title, description, primary, onClick }) {
	const content = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		className: cn("group flex flex-col h-full bg-white p-6 rounded-lg border border-border shadow-sm hover:shadow-md hover:-translate-y-[2px] transition-all duration-200", primary ? "bg-primary text-primary-foreground border-primary hover:border-primary/90" : "hover:border-primary"),
		children: [
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				...
				"data-uid": "src/components/hub/HubTatico.tsx:27:9",
				"data-prohibitions": "[editContent]",
				className: "grid grid-cols-1 lg:grid-cols-3 gap-6",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/hub/HubTatico.tsx:29:11",
						"data-prohibitions": "[editContent]",
						className: "bg-white p-6 rounded-lg shadow-sm border border-border",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							"data-uid": "src/components/hub/HubTatico.tsx:30:13",
							"data-prohibitions": "[]",
							className: "text-lg font-bold text-foreground mb-4",
							children: "Para Resolver HOJE 🚨"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							"data-uid": "src/components/hub/HubTatico.tsx:31:13",
							"data-prohibitions": "[editContent]",
							className: "space-y-4",
							children: [data.resolverHoje?.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								"data-uid": "src/components/hub/HubTatico.tsx:33:17",
								"data-prohibitions": "[]",
								className: "text-sm text-muted-foreground",
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
												"data-uid": "src/components/hub/HubTatico.tsx:52:23",
												"data-prohibitions": "[]",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/hub/HubTatico.tsx:61:11",
						"data-prohibitions": "[editContent]",
						className: "bg-white p-6 rounded-lg shadow-sm border border-border",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							"data-uid": "src/components/hub/HubTatico.tsx:62:13",
							"data-prohibitions": "[]",
							className: "text-lg font-bold text-foreground mb-4",
							children: "Aguardando sua Revisão 📄"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							"data-uid": "src/components/hub/HubTatico.tsx:63:13",
							"data-prohibitions": "[editContent]",
							className: "space-y-4",
							children: [data.aguardandoRevisao?.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								"data-uid": "src/components/hub/HubTatico.tsx:65:17",
								"data-prohibitions": "[]",
								className: "text-sm text-muted-foreground",
								children: "Nenhuma revisão pendente."
							}), data.aguardandoRevisao?.map((proc) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								"data-uid": "src/components/hub/HubTatico.tsx:68:17",
								"data-prohibitions": "[editContent]",
								className: "p-4 rounded-md border-l-4 shadow-sm bg-card border border-l-[#14b8a6]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									"data-uid": "src/components/hub/HubTatico.tsx:72:19",
									"data-prohibitions": "[editContent]",
									className: "flex items-start gap-3 mb-3",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileText, {
										"data-uid": "src/components/hub/HubTatico.tsx:73:21",
										"data-prohibitions": "[editContent]",
										className: "w-5 h-5 text-[#14b8a6] shrink-0"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										"data-uid": "src/components/hub/HubTatico.tsx:74:21",
										"data-prohibitions": "[editContent]",
										className: "overflow-hidden",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												"data-uid": "src/components/hub/HubTatico.tsx:75:23",
												"data-prohibitions": "[editContent]",
												className: "font-semibold text-sm truncate",
												children: proc.numero_processo || proc.numero_controle || "Processo"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
												"data-uid": "src/components/hub/HubTatico.tsx:78:23",
												"data-prohibitions": "[editContent]",
												className: "font-bold text-xs truncate mb-1",
												children: ["Tipo: ", proc.expand?.tipo_investigacao_id?.nome || "N/A"]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												"data-uid": "src/components/hub/HubTatico.tsx:81:23",
												"data-prohibitions": "[editContent]",
									...
									"data-uid": "src/components/hub/HubTatico.tsx:86:19",
									"data-prohibitions": "[]",
									size: "sm",
									asChild: true,
									className: "w-full h-8 text-xs font-bold bg-primary text-primary-foreground",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
										"data-uid": "src/components/hub/HubTatico.tsx:91:21",
										"data-prohibitions": "[]",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/hub/HubTatico.tsx:99:11",
						"data-prohibitions": "[editContent]",
						className: "bg-white p-6 rounded-lg shadow-sm border border-border",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							"data-uid": "src/components/hub/HubTatico.tsx:100:13",
							"data-prohibitions": "[]",
							className: "text-lg font-bold text-foreground mb-4",
							children: "Radar da Semana 📅"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							"data-uid": "src/components/hub/HubTatico.tsx:101:13",
							"data-prohibitions": "[editContent]",
							className: "space-y-4",
							children: [data.radarSemana?.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								"data-uid": "src/components/hub/HubTatico.tsx:103:17",
								"data-prohibitions": "[]",
								className: "text-sm text-muted-foreground",
...
//# sourceMappingURL=HubPage-BA2TwCyK.js.map