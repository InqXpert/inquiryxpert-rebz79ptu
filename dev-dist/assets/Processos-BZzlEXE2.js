...
import { n as BellRing, t as useAlertas } from './useAlertas-BXtXn2_S.js'
...
import { t as Inbox } from './inbox-BfhKUYIH.js'
import { t as MessageSquare } from './message-square-MrgDEEpG.js'
import { t as Pen } from './pen-CRsUUQBO.js'
import { t as Plus } from './plus-C_-Bfab_.js'
import { t as Search } from './search-D5ywL3r1.js'
import { t as Send } from './send-hUvYLYT-.js'
import { n as formatDateBr, t as cn } from './utils-BmdpXeKV.js'
...
import { t as EncaminharSindicanciaModal } from './EncaminharSindicanciaModal-ChvRplhL.js'
import {
  a as TableHeader,
  i as TableHead,
  n as TableBody,
...
import {
  ...
  p as filterByStatus,
  r as createAuditLog,
  t as calculateDayColor,
  u as filterByDate,
  v as searchProcessos,
} from './processosService-Qd6lQUDQ.js'
...
function HistoricoModal({ processo, isOpen, onClose }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
      ...
      'data-prohibitions': '[editContent]',
      className:
        'sm:max-w-[700px] w-full p-0 gap-0 max-h-[80vh] flex flex-col overflow-hidden bg-card border-border rounded-lg',
      children: [
                    ...
                    children: historico.map((h, i) =>
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                        TableRow,
                        {
                          ...
                          'data-prohibitions': '[editContent]',
                          className:
                            'h-[48px] hover:bg-muted animate-in fade-in fill-mode-both duration-200',
                          style: { animationDelay: `${i * 50}ms` },
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
                              'data-uid':
                                'src/components/operacional/ProcessoInlineModals.tsx:84:21',
                              'data-prohibitions': '[editContent]',
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
                              'data-uid':
                                'src/components/operacional/ProcessoInlineModals.tsx:87:21',
                              'data-prohibitions': '[editContent]',
                              className: 'text-[14px] whitespace-nowrap',
                              children:
                                h.expand?.usuario_id?.name ||
                                h.expand?.usuario_id?.email ||
                                'Sistema',
                            }),
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
                              'data-uid':
                                'src/components/operacional/ProcessoInlineModals.tsx:90:21',
                              'data-prohibitions': '[editContent]',
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
                              'data-uid':
                                'src/components/operacional/ProcessoInlineModals.tsx:93:21',
                              'data-prohibitions': '[editContent]',
                              className: 'text-[14px] min-w-[200px]',
                              children:
                                h.acao === 'EDITADO'
                                  ? 'Processo modificado'
                                  : h.dados_novos?.text || h.acao,
                            }),
                          ],
                        },
                        h.id,
...
function ObservacoesModal({ processo, isOpen, onClose }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await pb
        ...
        .update(processo.id, { observacoes_json: [...current, newObs] })
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
      ...
      'data-prohibitions': '[editContent]',
      className:
        'sm:max-w-[600px] w-full p-0 gap-0 max-h-[80vh] flex flex-col overflow-hidden bg-card border-border rounded-lg',
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogHeader, {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Textarea, {
                  ...
                  className:
                    'h-[100px] resize-none placeholder:text-muted-foreground focus-visible:ring-1 focus-visible:ring-primary focus-visible:border-primary',
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                  ...
                  className:
                    'h-[44px] w-full disabled:opacity-50 disabled:cursor-not-allowed bg-primary text-primary-foreground hover:bg-primary/90 transition-colors',
                ...
                existingObs.map((o, i) =>
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    'div',
                    {
                      ...
                      'data-prohibitions': '[editContent]',
                      className:
                        'mb-[12px] p-[12px] border border-border rounded-[6px] animate-in fade-in fill-mode-both duration-200',
                      style: { animationDelay: `${i * 50}ms` },
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                          ...
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                              'data-uid':
                                'src/components/operacional/ProcessoInlineModals.tsx:201:19',
                              'data-prohibitions': '[editContent]',
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                              'data-uid':
                                'src/components/operacional/ProcessoInlineModals.tsx:202:19',
                              'data-prohibitions': '[editContent]',
...
function PosicoesModal({ processo, isOpen, onClose }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await pb
        .collection('processos_operacionais')
        .update(processo.id, { posicoes_json: [...current, newPos] })
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                          ...
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                              'data-uid':
                                'src/components/operacional/ProcessoInlineModals.tsx:302:19',
                              'data-prohibitions': '[editContent]',
                              className: 'text-[12px] font-bold text-foreground truncate',
                              children: p.user,
                            }),
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                              'data-uid':
                                'src/components/operacional/ProcessoInlineModals.tsx:303:19',
                              'data-prohibitions': '[editContent]',
                              className: 'text-[12px] text-muted-foreground whitespace-nowrap',
...
function ProcessoTimeline({ processoId }) {
  ...
  if (historico.length === 0)
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
      ...
      'data-prohibitions': '[]',
      className:
        'text-[13px] text-brand-gray dark:text-brand-light px-2 py-6 text-center font-medium',
          ...
          children: [
            i !== historico.length - 1 &&
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                ...
                'data-prohibitions': '[editContent]',
                className:
                  'absolute left-[11px] top-7 bottom-0 w-[2px] bg-brand-teal/20 dark:bg-brand-cyan/20',
              }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
              'data-uid': 'src/components/operacional/ProcessoTimeline.tsx:58:11',
              'data-prohibitions': '[editContent]',
              className:
                'w-6 h-6 rounded-full bg-brand-light dark:bg-brand-navy border-[4px] border-brand-cyan flex-shrink-0 mt-1 z-10 shadow-sm',
            }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
              'data-uid': 'src/components/operacional/ProcessoTimeline.tsx:59:11',
              'data-prohibitions': '[editContent]',
              className:
                'flex-1 bg-white dark:bg-brand-navy/60 p-3.5 rounded-xl border border-brand-teal/10 dark:border-brand-cyan/20 shadow-sm',
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                  'data-uid': 'src/components/operacional/ProcessoTimeline.tsx:60:13',
                  'data-prohibitions': '[editContent]',
                  className:
                    'text-[14px] font-bold text-brand-navy dark:text-white mb-1.5 uppercase tracking-wide',
                ...
                h.descricao &&
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                    ...
                    'data-prohibitions': '[editContent]',
                    className:
                      'text-[13px] text-brand-gray dark:text-brand-light mb-3 leading-relaxed',
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                      ...
                      'data-prohibitions': '[editContent]',
                      className:
                        'font-bold text-brand-teal dark:text-brand-cyan bg-brand-teal/10 dark:bg-brand-cyan/10 px-2 py-0.5 rounded-md',
...
function ProcessosTableRowDesktop({ processo: p, index: i, expanded, onToggle, onOpenModal }) {
  ...
  const [isEncaminharModalOpen, setIsEncaminharModalOpen] = (0, import_react.useState)(false)
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_react.Fragment, {
    'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:40:5',
    'data-prohibitions': '[editContent]',
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableRow, {
        'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:41:7',
        'data-prohibitions': '[editContent]',
        className: cn(
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
            'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:53:9',
            'data-prohibitions': '[editContent]',
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
            'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:59:9',
            'data-prohibitions': '[editContent]',
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
              'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:60:11',
              'data-prohibitions': '[editContent]',
              className: 'flex flex-col gap-1.5 items-start',
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('span', {
                  'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:61:13',
                  'data-prohibitions': '[editContent]',
                  className:
                    'font-bold text-xs uppercase truncate w-full text-brand-navy dark:text-white flex items-center gap-1',
                  title: p.status?.replace(/_/g, ' '),
                  children: [
                    p.status ? p.status.replace(/_/g, ' ') : '-',
                    p.prioridade &&
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                        'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:67:17',
                        'data-prohibitions': '[editContent]',
                        className: cn(
                ...
                tags.length > 0 &&
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                    'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:82:15',
                    'data-prohibitions': '[editContent]',
                    className: 'flex flex-wrap gap-1 w-full',
                    children: tags.map((t, idx) =>
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                        'span',
                        {
                          'data-uid':
                            'src/components/operacional/ProcessosTableRowDesktop.tsx:84:19',
                          'data-prohibitions': '[editContent]',
                          className: cn(
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
            'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:99:9',
            'data-prohibitions': '[editContent]',
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
            'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:105:9',
            'data-prohibitions': '[editContent]',
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
            'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:111:9',
            'data-prohibitions': '[editContent]',
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
            ...
            'data-prohibitions': '[editContent]',
            className:
              'text-xs text-brand-gray dark:text-brand-light truncate hidden lg:table-cell',
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
            ...
            'data-prohibitions': '[editContent]',
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
              'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:124:11',
              'data-prohibitions': '[editContent]',
              ...
              children: [
                ...
                p.tags.filter((t) => typeof t === 'string' && t.trim() !== '').length > 0
                  ? p.tags
                      ...
                      .map((tag, idx) =>
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                          ...
                          {
                            'data-uid':
                              'src/components/operacional/ProcessosTableRowDesktop.tsx:131:19',
                            'data-prohibitions': '[editContent]',
                            className: cn(
                  ...
                  : /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                      'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:143:15',
                      'data-prohibitions': '[]',
                ...
                Array.isArray(p.tags) &&
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Badge, {
                    'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:147:17',
                    'data-prohibitions': '[editContent]',
                    className:
                      'text-[9px] px-1.5 py-0 rounded-[4px] bg-brand-light text-brand-gray dark:bg-black/50 dark:text-brand-light border-transparent leading-tight',
                    title: p.tags
                      .filter((t) => typeof t === 'string' && t.trim() !== '')
                      .slice(2)
                      .join(', '),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
            ...
            'data-prohibitions': '[editContent]',
            className:
              'font-medium text-xs text-brand-gray dark:text-brand-light whitespace-nowrap',
            title: p.data_entrada ? formatDateBr(p.data_entrada) : '-',
            children: p.data_entrada ? formatDateBr(p.data_entrada) : '-',
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
            'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:165:9',
            'data-prohibitions': '[editContent]',
            className: 'text-right pr-4',
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, {
              'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:166:11',
              'data-prohibitions': '[editContent]',
              className: cn(
      ...
      expanded &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableRow, {
          'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:176:9',
          'data-prohibitions': '[]',
          className:
            'bg-brand-light/30 dark:bg-black/20 hover:bg-brand-light/30 dark:hover:bg-black/20 border-b-brand-teal/20 dark:border-b-brand-cyan/20',
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
            'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:177:11',
            'data-prohibitions': '[]',
            colSpan: 9,
            className: 'p-0 border-t border-brand-teal/10 dark:border-brand-cyan/10',
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
              'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:181:13',
              'data-prohibitions': '[]',
              className: 'p-4 md:p-6 animate-in slide-in-from-top-2 fade-in duration-200',
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                  'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:182:15',
                  'data-prohibitions': '[]',
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                      ...
                      size: 'sm',
                      className:
                        'bg-brand-cyan text-brand-navy hover:bg-brand-cyan/90 font-bold shadow-sm min-h-[44px]',
                      onClick: (e) => {
                        e.stopPropagation()
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pen, {
                          'data-uid':
                            'src/components/operacional/ProcessosTableRowDesktop.tsx:191:19',
                          'data-prohibitions': '[editContent]',
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                      'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:193:17',
                      'data-prohibitions': '[]',
                      variant: 'secondary',
                      size: 'sm',
                      className:
                        'h-11 w-11 px-0 sm:w-auto sm:px-3 sm:h-10 flex items-center justify-center font-bold text-brand-navy dark:text-white focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none',
                      onClick: (e) => {
                        e.stopPropagation()
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Send, {
                          'data-uid':
                            'src/components/operacional/ProcessosTableRowDesktop.tsx:203:19',
                          'data-prohibitions': '[editContent]',
                          className: 'w-4 h-4 sm:mr-2',
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                          'data-uid':
                            'src/components/operacional/ProcessosTableRowDesktop.tsx:204:19',
                          'data-prohibitions': '[]',
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                      'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:206:17',
                      'data-prohibitions': '[]',
                      variant: 'outline',
                      size: 'sm',
                      className:
                        'border-brand-teal/20 dark:border-brand-cyan/20 font-bold text-brand-navy dark:text-white bg-white dark:bg-brand-navy min-h-[44px]',
                      onClick: (e) => {
                        e.stopPropagation()
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(History, {
                          'data-uid':
                            'src/components/operacional/ProcessosTableRowDesktop.tsx:215:19',
                          'data-prohibitions': '[editContent]',
                          className: 'w-4 h-4 mr-2',
                        }),
                        ' Histórico',
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageSquare, {
                          'data-uid':
                            'src/components/operacional/ProcessosTableRowDesktop.tsx:226:19',
                          'data-prohibitions': '[editContent]',
                          className: 'w-4 h-4 mr-2',
                        }),
                        ' Observações',
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                      'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:228:17',
                      'data-prohibitions': '[]',
                      variant: 'outline',
                      size: 'sm',
                      className:
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Flag, {
                          'data-uid':
                            'src/components/operacional/ProcessosTableRowDesktop.tsx:237:19',
                          'data-prohibitions': '[editContent]',
                          className: 'w-4 h-4 mr-2',
                        }),
                        ' Posições',
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)('h4', {
                  'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:240:15',
                  'data-prohibitions': '[]',
                  className: 'text-[14px] font-bold text-brand-navy dark:text-white mb-3 ml-2',
                  children: 'Linha do Tempo de Atividades',
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                  'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:243:15',
                  'data-prohibitions': '[]',
                  className:
                    'bg-white/50 dark:bg-brand-navy/30 rounded-xl p-2 border border-brand-teal/10 dark:border-brand-cyan/10 max-w-4xl',
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProcessoTimeline, {
                    'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:244:17',
                    'data-prohibitions': '[editContent]',
                    processoId: p.id,
                  }),
                }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EncaminharSindicanciaModal, {
        'data-uid': 'src/components/operacional/ProcessosTableRowDesktop.tsx:250:7',
        'data-prohibitions': '[editContent]',
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            'data-uid': 'src/components/operacional/ProcessosTableRowMobile.tsx:84:9',
            'data-prohibitions': '[editContent]',
            className: 'flex justify-between',
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                'data-uid': 'src/components/operacional/ProcessosTableRowMobile.tsx:85:11',
                'data-prohibitions': '[]',
                className: 'text-brand-gray dark:text-brand-light',
                children: 'Prestador:',
              }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                'data-uid': 'src/components/operacional/ProcessosTableRowMobile.tsx:86:11',
                'data-prohibitions': '[editContent]',
                className: 'font-medium text-brand-navy dark:text-white truncate max-w-[180px]',
                children:
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            'data-uid': 'src/components/operacional/ProcessosTableRowMobile.tsx:90:9',
            'data-prohibitions': '[editContent]',
            className: 'flex justify-between',
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                'data-uid': 'src/components/operacional/ProcessosTableRowMobile.tsx:91:11',
                'data-prohibitions': '[]',
                className: 'text-brand-gray dark:text-brand-light',
                children: 'Prioridade:',
              }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                'data-uid': 'src/components/operacional/ProcessosTableRowMobile.tsx:92:11',
                'data-prohibitions': '[editContent]',
      ...
      (tags.length > 0 ||
        (Array.isArray(p.tags) &&
          p.tags.filter((t) => typeof t === 'string' && t.trim() !== '').length > 0)) &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
          'data-uid': 'src/components/operacional/ProcessosTableRowMobile.tsx:101:9',
          'data-prohibitions': '[editContent]',
          ...
          children: [
            tags.map((t, idx) =>
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                'span',
                {
                  'data-uid': 'src/components/operacional/ProcessosTableRowMobile.tsx:103:13',
                  'data-prohibitions': '[editContent]',
              ...
              p.tags
                ...
                .map((tag, idx) =>
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    Badge,
                    {
                      'data-uid': 'src/components/operacional/ProcessosTableRowMobile.tsx:114:17',
                      'data-prohibitions': '[editContent]',
      ...
      expanded &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
          'data-uid': 'src/components/operacional/ProcessosTableRowMobile.tsx:125:9',
          'data-prohibitions': '[]',
          className:
            'mt-4 pt-4 border-t border-brand-teal/10 dark:border-brand-cyan/10 animate-in fade-in slide-in-from-top-2',
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
              'data-uid': 'src/components/operacional/ProcessosTableRowMobile.tsx:126:11',
              'data-prohibitions': '[]',
              className: 'flex flex-col gap-2 mb-4',
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                  'data-uid': 'src/components/operacional/ProcessosTableRowMobile.tsx:127:13',
                  'data-prohibitions': '[]',
                  size: 'sm',
                  className:
                    'bg-brand-cyan text-brand-navy hover:bg-brand-cyan/90 font-bold w-full justify-start min-h-[44px]',
                  onClick: (e) => {
                    e.stopPropagation()
                    navigate(`/processos/${p.id}/editar`)
                  },
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pen, {
                      'data-uid': 'src/components/operacional/ProcessosTableRowMobile.tsx:135:15',
                      'data-prohibitions': '[editContent]',
                      className: 'w-4 h-4 mr-2',
                    }),
                    ' Editar Processo',
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                  'data-uid': 'src/components/operacional/ProcessosTableRowMobile.tsx:137:13',
                  'data-prohibitions': '[]',
                  className: 'grid grid-cols-2 gap-2',
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                      'data-uid': 'src/components/operacional/ProcessosTableRowMobile.tsx:138:15',
                      'data-prohibitions': '[]',
                      variant: 'outline',
                      size: 'sm',
                      className:
                        'w-full bg-white dark:bg-brand-navy border-brand-teal/20 dark:border-brand-cyan/20 min-h-[44px]',
                      onClick: (e) => {
                        e.stopPropagation()
                        onOpenModal('history', p)
                      },
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(History, {
                          'data-uid':
                            'src/components/operacional/ProcessosTableRowMobile.tsx:147:17',
                          'data-prohibitions': '[editContent]',
                          className: 'w-4 h-4 mr-2',
                        }),
                        ' Histórico',
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                      'data-uid': 'src/components/operacional/ProcessosTableRowMobile.tsx:149:15',
                      'data-prohibitions': '[]',
                      variant: 'outline',
                      size: 'sm',
                      className:
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageSquare, {
                          'data-uid':
                            'src/components/operacional/ProcessosTableRowMobile.tsx:158:17',
                          'data-prohibitions': '[editContent]',
                          className: 'w-4 h-4 mr-2',
                        }),
                        ' Obs',
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                  'data-uid': 'src/components/operacional/ProcessosTableRowMobile.tsx:161:13',
                  'data-prohibitions': '[]',
                  variant: 'outline',
                  size: 'sm',
                  className:
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Flag, {
                      'data-uid': 'src/components/operacional/ProcessosTableRowMobile.tsx:170:15',
                      'data-prohibitions': '[editContent]',
                      className: 'w-4 h-4 mr-2',
                    }),
                    ' Posições',
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('h4', {
              'data-uid': 'src/components/operacional/ProcessosTableRowMobile.tsx:173:11',
              'data-prohibitions': '[]',
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
              ...
              'data-prohibitions': '[]',
              className:
                'bg-brand-light/30 dark:bg-black/20 rounded-xl p-1 border border-brand-teal/10 dark:border-brand-cyan/10',
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProcessoTimeline, {
                'data-uid': 'src/components/operacional/ProcessosTableRowMobile.tsx:177:13',
                'data-prohibitions': '[editContent]',
                processoId: p.id,
              }),
            }),
...
function ProcessosListTable({ processos, loading, hasMore, onLoadMore, rawCount }) {
  ...
  if (loading && processos.length === 0)
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
          'data-uid': 'src/components/operacional/ProcessosListTable.tsx:35:9',
          'data-prohibitions': '[editContent]',
          className:
            'hidden md:block bg-white dark:bg-brand-navy/80 border border-brand-teal/20 dark:border-brand-cyan/20 rounded-xl overflow-hidden shadow-sm',
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Table, {
            'data-uid': 'src/components/operacional/ProcessosListTable.tsx:36:11',
            'data-prohibitions': '[editContent]',
            className: 'table-fixed w-full',
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHeader, {
                'data-uid': 'src/components/operacional/ProcessosListTable.tsx:37:13',
                'data-prohibitions': '[]',
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableRow, {
                  ...
                  'data-prohibitions': '[]',
                  className:
                    'hover:bg-transparent border-b-brand-teal/20 dark:border-b-brand-cyan/20',
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                      'data-uid': 'src/components/operacional/ProcessosListTable.tsx:42:17',
                      'data-prohibitions': '[]',
                      className: 'w-[12%] font-bold text-brand-navy dark:text-white text-xs',
                      children: 'STATUS',
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                      'data-uid': 'src/components/operacional/ProcessosListTable.tsx:45:17',
                      'data-prohibitions': '[]',
                      className: 'w-[10%] font-bold text-brand-navy dark:text-white text-xs',
                      children: 'SUPERVISOR',
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                      'data-uid': 'src/components/operacional/ProcessosListTable.tsx:48:17',
                      'data-prohibitions': '[]',
                      className: 'w-[10%] font-bold text-brand-navy dark:text-white text-xs',
                      children: 'SEGURADORA',
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                      'data-uid': 'src/components/operacional/ProcessosListTable.tsx:51:17',
                      'data-prohibitions': '[]',
                      className: 'w-[14%] font-bold text-brand-navy dark:text-white text-xs',
                      children: 'TIPO',
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                      'data-uid': 'src/components/operacional/ProcessosListTable.tsx:54:17',
                      'data-prohibitions': '[]',
                      className:
                        'w-[10%] hidden lg:table-cell font-bold text-brand-navy dark:text-white text-xs',
                      children: 'AGENTE',
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                      'data-uid': 'src/components/operacional/ProcessosListTable.tsx:57:17',
                      'data-prohibitions': '[]',
                      className: 'w-[12%] font-bold text-brand-navy dark:text-white text-xs',
                      children: 'TAGS',
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                      'data-uid': 'src/components/operacional/ProcessosListTable.tsx:60:17',
                      'data-prohibitions': '[]',
                      className: 'w-[14%] font-bold text-brand-navy dark:text-white text-xs',
                      children: 'ENTRADA',
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                      'data-uid': 'src/components/operacional/ProcessosListTable.tsx:63:17',
                      'data-prohibitions': '[]',
                      className: 'w-[4%]',
                    }),
                  ],
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableBody, {
                'data-uid': 'src/components/operacional/ProcessosListTable.tsx:66:13',
                'data-prohibitions': '[editContent]',
                children: Array.from({ length: 10 }).map((_, i) =>
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    TableRow,
                    {
                      'data-uid': 'src/components/operacional/ProcessosListTable.tsx:68:17',
                      'data-prohibitions': '[]',
                      className: 'border-b-brand-teal/10 dark:border-b-brand-cyan/10 h-[64px]',
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
                          'data-uid': 'src/components/operacional/ProcessosListTable.tsx:72:19',
                          'data-prohibitions': '[]',
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Skeleton, {
                            'data-uid': 'src/components/operacional/ProcessosListTable.tsx:73:21',
                            'data-prohibitions': '[editContent]',
                            className: 'h-4 w-[90%]',
                          }),
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
                          'data-uid': 'src/components/operacional/ProcessosListTable.tsx:75:19',
                          'data-prohibitions': '[]',
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Skeleton, {
                            'data-uid': 'src/components/operacional/ProcessosListTable.tsx:76:21',
                            'data-prohibitions': '[editContent]',
                            className: 'h-6 w-[80%]',
                          }),
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
                          'data-uid': 'src/components/operacional/ProcessosListTable.tsx:78:19',
                          'data-prohibitions': '[]',
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Skeleton, {
                            'data-uid': 'src/components/operacional/ProcessosListTable.tsx:79:21',
                            'data-prohibitions': '[editContent]',
                            className: 'h-4 w-[90%]',
                          }),
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
                          'data-uid': 'src/components/operacional/ProcessosListTable.tsx:81:19',
                          'data-prohibitions': '[]',
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Skeleton, {
                            'data-uid': 'src/components/operacional/ProcessosListTable.tsx:82:21',
                            'data-prohibitions': '[editContent]',
                            className: 'h-4 w-[80%]',
                          }),
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
                          'data-uid': 'src/components/operacional/ProcessosListTable.tsx:84:19',
                          'data-prohibitions': '[]',
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Skeleton, {
                            'data-uid': 'src/components/operacional/ProcessosListTable.tsx:85:21',
                            'data-prohibitions': '[editContent]',
                            className: 'h-4 w-[80%]',
                          }),
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
                          'data-uid': 'src/components/operacional/ProcessosListTable.tsx:87:19',
                          'data-prohibitions': '[]',
                          className: 'hidden lg:table-cell',
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Skeleton, {
                            'data-uid': 'src/components/operacional/ProcessosListTable.tsx:88:21',
                            'data-prohibitions': '[editContent]',
                            className: 'h-4 w-[90%]',
                          }),
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
                          'data-uid': 'src/components/operacional/ProcessosListTable.tsx:90:19',
                          'data-prohibitions': '[]',
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Skeleton, {
                            'data-uid': 'src/components/operacional/ProcessosListTable.tsx:91:21',
                            'data-prohibitions': '[editContent]',
                            className: 'h-6 w-[80%]',
                          }),
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
                          'data-uid': 'src/components/operacional/ProcessosListTable.tsx:93:19',
                          'data-prohibitions': '[]',
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Skeleton, {
                            'data-uid': 'src/components/operacional/ProcessosListTable.tsx:94:21',
                            'data-prohibitions': '[editContent]',
                            className: 'h-4 w-[70%]',
                          }),
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
                          'data-uid': 'src/components/operacional/ProcessosListTable.tsx:96:19',
                          'data-prohibitions': '[]',
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Skeleton, {
                            'data-uid': 'src/components/operacional/ProcessosListTable.tsx:97:21',
                            'data-prohibitions': '[editContent]',
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
          'data-uid': 'src/components/operacional/ProcessosListTable.tsx:104:9',
          'data-prohibitions': '[editContent]',
          ...
          children: Array.from({ length: 5 }).map((_, i) =>
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              Skeleton,
              {
                'data-uid': 'src/components/operacional/ProcessosListTable.tsx:106:13',
                'data-prohibitions': '[editContent]',
                className:
                  'h-[180px] w-full rounded-xl bg-white dark:bg-brand-navy border border-brand-teal/20',
              },
              i,
            ),
          ),
  ...
  if (processos.length === 0) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
      'data-uid': 'src/components/operacional/ProcessosListTable.tsx:119:7',
      'data-prohibitions': '[editContent]',
      className:
        'flex flex-col items-center justify-center text-center py-[60px] px-[24px] bg-white dark:bg-brand-navy/80 border border-brand-teal/20 dark:border-brand-cyan/20 rounded-xl shadow-sm animate-in fade-in duration-300',
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)('h3', {
          'data-uid': 'src/components/operacional/ProcessosListTable.tsx:121:9',
          'data-prohibitions': '[editContent]',
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
          'data-uid': 'src/components/operacional/ProcessosListTable.tsx:126:9',
          'data-prohibitions': '[editContent]',
        ...
        !isFiltering &&
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
            'data-uid': 'src/components/operacional/ProcessosListTable.tsx:132:11',
            'data-prohibitions': '[]',
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
        'data-uid': 'src/components/operacional/ProcessosListTable.tsx:145:7',
        'data-prohibitions': '[editContent]',
        className:
          'hidden md:block bg-white dark:bg-brand-navy/80 border border-brand-teal/20 dark:border-brand-cyan/20 rounded-xl overflow-hidden shadow-sm',
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Table, {
          'data-uid': 'src/components/operacional/ProcessosListTable.tsx:146:9',
          'data-prohibitions': '[editContent]',
          className: 'table-fixed w-full',
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHeader, {
              'data-uid': 'src/components/operacional/ProcessosListTable.tsx:147:11',
              'data-prohibitions': '[]',
              className: 'bg-brand-light/30 dark:bg-black/10',
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableRow, {
                'data-uid': 'src/components/operacional/ProcessosListTable.tsx:148:13',
                'data-prohibitions': '[]',
                className:
                  'hover:bg-transparent border-b-brand-teal/20 dark:border-b-brand-cyan/20',
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                    'data-uid': 'src/components/operacional/ProcessosListTable.tsx:149:15',
                    'data-prohibitions': '[]',
                    className: 'w-[14%] font-bold text-brand-navy dark:text-white text-xs',
                    children: 'ID / CONTROLE',
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                    'data-uid': 'src/components/operacional/ProcessosListTable.tsx:152:15',
                    'data-prohibitions': '[]',
                    className: 'w-[12%] font-bold text-brand-navy dark:text-white text-xs',
                    children: 'STATUS',
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                    'data-uid': 'src/components/operacional/ProcessosListTable.tsx:155:15',
                    'data-prohibitions': '[]',
                    className: 'w-[10%] font-bold text-brand-navy dark:text-white text-xs',
                    children: 'SUPERVISOR',
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                    'data-uid': 'src/components/operacional/ProcessosListTable.tsx:158:15',
                    'data-prohibitions': '[]',
                    className: 'w-[10%] font-bold text-brand-navy dark:text-white text-xs',
                    children: 'SEGURADORA',
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                    'data-uid': 'src/components/operacional/ProcessosListTable.tsx:161:15',
                    'data-prohibitions': '[]',
                    className: 'w-[14%] font-bold text-brand-navy dark:text-white text-xs',
                    children: 'TIPO',
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                    'data-uid': 'src/components/operacional/ProcessosListTable.tsx:164:15',
                    'data-prohibitions': '[]',
                    className:
                      'w-[10%] hidden lg:table-cell font-bold text-brand-navy dark:text-white text-xs',
                    children: 'AGENTE',
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                    'data-uid': 'src/components/operacional/ProcessosListTable.tsx:167:15',
                    'data-prohibitions': '[]',
                    className: 'w-[12%] font-bold text-brand-navy dark:text-white text-xs',
                    children: 'TAGS',
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                    'data-uid': 'src/components/operacional/ProcessosListTable.tsx:170:15',
                    'data-prohibitions': '[]',
                    className: 'w-[14%] font-bold text-brand-navy dark:text-white text-xs',
                    children: 'ENTRADA',
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                    'data-uid': 'src/components/operacional/ProcessosListTable.tsx:173:15',
                    'data-prohibitions': '[]',
                    className: 'w-[4%]',
                  }),
                ],
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableBody, {
              'data-uid': 'src/components/operacional/ProcessosListTable.tsx:176:11',
              'data-prohibitions': '[editContent]',
              children: processos.map((p, i) =>
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  ProcessosTableRowDesktop,
                  {
                    'data-uid': 'src/components/operacional/ProcessosListTable.tsx:178:15',
                    'data-prohibitions': '[editContent]',
                    processo: p,
                    index: i,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
        'data-uid': 'src/components/operacional/ProcessosListTable.tsx:191:7',
        'data-prohibitions': '[editContent]',
        className: 'md:hidden space-y-4',
        children: processos.map((p, i) =>
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            ...
            {
              'data-uid': 'src/components/operacional/ProcessosListTable.tsx:193:11',
              'data-prohibitions': '[editContent]',
              processo: p,
              index: i,
              expanded: expandedId === p.id,
      ...
      hasMore &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
          'data-uid': 'src/components/operacional/ProcessosListTable.tsx:205:9',
          'data-prohibitions': '[]',
          className: 'mt-6 flex justify-center',
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
            'data-uid': 'src/components/operacional/ProcessosListTable.tsx:206:11',
            'data-prohibitions': '[]',
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ObservacoesModal, {
        'data-uid': 'src/components/operacional/ProcessosListTable.tsx:220:7',
        'data-prohibitions': '[editContent]',
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PosicoesModal, {
        'data-uid': 'src/components/operacional/ProcessosListTable.tsx:225:7',
        'data-prohibitions': '[editContent]',
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EncaminharSindicanciaModal, {
        'data-uid': 'src/components/operacional/ProcessosListTable.tsx:230:7',
        'data-prohibitions': '[editContent]',
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            ...
            children: [
                    ...
                    children: [
                      ...
                      supervisores.map((s) =>
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                          ...
                          {
                            'data-uid':
                              'src/components/operacional/ProcessosListFilters.tsx:105:17',
                            'data-prohibitions': '[editContent]',
                            value: s.id,
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                ...
                size: 'icon',
                className:
                  'h-11 w-11 min-h-[44px] min-w-[44px] shrink-0 text-foreground hover:opacity-80 transition-opacity hover:bg-transparent',
...
function Processos() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
    'data-uid': 'src/pages/Processos.tsx:27:5',
    'data-prohibitions': '[editContent]',
    className:
      'w-full max-w-[1600px] mx-auto px-4 md:px-6 py-6 md:py-8 animate-in fade-in duration-500',
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        'data-uid': 'src/pages/Processos.tsx:28:7',
        'data-prohibitions': '[editContent]',
        className: 'mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4',
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            'data-uid': 'src/pages/Processos.tsx:29:9',
            'data-prohibitions': '[]',
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)('h1', {
                'data-uid': 'src/pages/Processos.tsx:30:11',
                'data-prohibitions': '[]',
                className:
                  'text-[28px] font-bold tracking-tight text-brand-navy dark:text-white mb-1',
                children: 'Processos',
              }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                'data-uid': 'src/pages/Processos.tsx:33:11',
                'data-prohibitions': '[]',
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            'data-uid': 'src/pages/Processos.tsx:37:9',
            'data-prohibitions': '[editContent]',
            className: 'flex flex-col sm:flex-row items-stretch sm:items-center gap-3',
            children: [
              canViewAlerts &&
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                  'data-uid': 'src/pages/Processos.tsx:39:13',
                  'data-prohibitions': '[editContent]',
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BellRing, {
                      'data-uid': 'src/pages/Processos.tsx:54:15',
                      'data-prohibitions': '[editContent]',
                      className: 'w-4 h-4 mr-2',
                    }),
                    'Central de Alertas',
                    alertsCount > 0 &&
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                        'data-uid': 'src/pages/Processos.tsx:57:17',
                        'data-prohibitions': '[editContent]',
                        className: cn(
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                ...
                onClick: () => navigate('/processos/novo'),
                className:
                  'bg-brand-cyan text-brand-navy hover:bg-brand-cyan/90 font-bold shadow-sm',
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, {
                    'data-uid': 'src/pages/Processos.tsx:76:13',
                    'data-prohibitions': '[editContent]',
                    className: 'w-4 h-4 mr-2',
                  }),
                  'Novo Processo',
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
        'data-uid': 'src/pages/Processos.tsx:82:7',
        'data-prohibitions': '[]',
        className:
          'sticky top-0 z-20 bg-background/95 dark:bg-brand-navy/95 backdrop-blur-md py-4 px-4 md:px-6 -mx-4 md:-mx-6 mb-6',
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProcessosListFilters, {
          'data-uid': 'src/pages/Processos.tsx:83:9',
          'data-prohibitions': '[editContent]',
          ...state,
        }),
      }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ErrorBoundary, {
        'data-uid': 'src/pages/Processos.tsx:86:7',
        'data-prohibitions': '[]',
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProcessosListTable, {
          'data-uid': 'src/pages/Processos.tsx:87:9',
          'data-prohibitions': '[editContent]',
...
//# sourceMappingURL=Processos-BZzlEXE2.js.map
