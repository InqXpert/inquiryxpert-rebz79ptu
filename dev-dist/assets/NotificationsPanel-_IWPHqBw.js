...
import { r as ptBR, t as cn } from './utils-BmdpXeKV.js'
...
import { O as useRealtime, V as Link, u as useHubPage } from './index-DJeO_T7s.js'
...
function getNotificationIcon(titulo, tipo) {
  ...
  if (
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheckBig, {
  ...
  if (
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, {
  ...
  if (lowerTitle.includes('e-mail') || lowerTitle.includes('email'))
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Mail, {
...
var NotificationsPanel = (0, import_react.memo)(function NotificationsPanel() {
  ...
  const fetchNotifications = (0, import_react.useCallback)(async () => {
    ...
    try {
      ...
      setNotifications(
        (
          await pb.collection('notificacoes_agente').getList(1, 10, {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
    ...
    'data-prohibitions': '[editContent]',
    className:
      'bg-card rounded-lg p-4 shadow-sm border border-border transition-all duration-200 ease-in-out hover:shadow-md h-full flex flex-col',
    children: [
            ...
            children: [
              ...
              unreadCount > 0 &&
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                  ...
                  'data-prohibitions': '[editContent]',
                  className:
                    'flex items-center justify-center w-6 h-6 rounded-full bg-destructive text-destructive-foreground text-xs font-bold',
          ...
          loading && notifications.length === 0
            ...
            : notifications.length === 0
              ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                  ...
                  'data-prohibitions': '[]',
                  className:
                    'flex flex-col items-center justify-center h-full space-y-2 text-muted-foreground py-8',
                  children: [
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                              ...
                              'data-prohibitions': '[editContent]',
                              className:
                                'text-xs text-muted-foreground line-clamp-2 mt-0.5 leading-relaxed',
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                              ...
                              'data-prohibitions': '[editContent]',
                              className:
                                'text-[10px] font-medium text-muted-foreground/70 mt-1.5 uppercase',
                        ...
                        !n.lida &&
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                            ...
                            'data-prohibitions': '[]',
                            className:
                              'w-2 h-2 rounded-full bg-destructive shrink-0 mt-1 shadow-sm shadow-destructive/50',
                          }),
                      ],
                    },
                    n.id,
...
//# sourceMappingURL=NotificationsPanel-_IWPHqBw.js.map
