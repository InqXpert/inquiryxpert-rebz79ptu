...
import { G as useNavigate, M as Button, d as toast } from './index-DJeO_T7s.js'
import {
  a as DialogHeader,
  i as DialogFooter,
  n as DialogContent,
...
var ALLOWED_EXTS = ['pdf', 'doc', 'docx', 'xls', 'xlsx', 'jpg', 'jpeg', 'png', 'gif']
      ...
      children: [
        ...
        loading &&
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            ...
            'data-prohibitions': '[]',
            className:
              'absolute inset-0 z-50 flex flex-col items-center justify-center bg-white/80 dark:bg-black/80 rounded-md',
            children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
                        'data-uid':
                          'src/components/sindicancia/EncaminharSindicanciaModal.tsx:121:17',
                        'data-prohibitions': '[]',
                        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, {
                          'data-uid':
                            'src/components/sindicancia/EncaminharSindicanciaModal.tsx:122:19',
                          'data-prohibitions': '[editContent]',
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectContent, {
                        'data-uid':
                          'src/components/sindicancia/EncaminharSindicanciaModal.tsx:124:17',
                        'data-prohibitions': '[editContent]',
                        children: processos?.map((p) =>
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                            ...
                            {
                              'data-uid':
                                'src/components/sindicancia/EncaminharSindicanciaModal.tsx:126:21',
                              'data-prohibitions': '[editContent]',
                              value: p.id,
                              children: [p.numero_controle || p.id, ' - ', p.status],
                            },
                            p.id,
                          ),
                        ),
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CloudUpload, {
                      'data-uid':
                        'src/components/sindicancia/EncaminharSindicanciaModal.tsx:155:15',
                      'data-prohibitions': '[editContent]',
                      className: 'h-8 w-8 text-muted-foreground mb-2',
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                      'data-uid':
                        'src/components/sindicancia/EncaminharSindicanciaModal.tsx:156:15',
                      'data-prohibitions': '[]',
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)('input', {
                      'data-uid':
                        'src/components/sindicancia/EncaminharSindicanciaModal.tsx:159:15',
                      'data-prohibitions': '[editContent]',
                      type: 'file',
                      multiple: true,
                      className: 'hidden',
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                    ...
                    children: documentos.map((doc) =>
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                        ...
                        {
                          'data-uid':
                            'src/components/sindicancia/EncaminharSindicanciaModal.tsx:175:19',
                          'data-prohibitions': '[editContent]',
                          className:
                            'flex items-center justify-between p-2 border rounded text-sm bg-background',
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                              'data-uid':
                                'src/components/sindicancia/EncaminharSindicanciaModal.tsx:179:21',
                              'data-prohibitions': '[editContent]',
                              className: 'flex items-center gap-2 overflow-hidden',
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(File, {
                                  'data-uid':
                                    'src/components/sindicancia/EncaminharSindicanciaModal.tsx:180:23',
                                  'data-prohibitions': '[editContent]',
                                  className: 'h-4 w-4 text-blue-500 shrink-0',
                                }),
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                                  'data-uid':
                                    'src/components/sindicancia/EncaminharSindicanciaModal.tsx:181:23',
                                  'data-prohibitions': '[editContent]',
                                  className: 'truncate',
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('span', {
                                  'data-uid':
                                    'src/components/sindicancia/EncaminharSindicanciaModal.tsx:182:23',
                                  'data-prohibitions': '[editContent]',
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                              'data-uid':
                                'src/components/sindicancia/EncaminharSindicanciaModal.tsx:186:21',
                              'data-prohibitions': '[]',
                              variant: 'ghost',
                              size: 'icon',
                              ...
                              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, {
                                'data-uid':
                                  'src/components/sindicancia/EncaminharSindicanciaModal.tsx:192:23',
                                'data-prohibitions': '[editContent]',
                                className: 'h-4 w-4',
                              }),
                            }),
...
//# sourceMappingURL=EncaminharSindicanciaModal-ChvRplhL.js.map
