...
import { A as AvatarFallback, V as Link, j as AvatarImage, k as Avatar } from './index-DJeO_T7s.js'
...
var UserGreeting = (0, import_react.memo)(function UserGreeting() {
  ...
  if (loading)
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
      ...
      'data-prohibitions': '[]',
      className:
        'flex flex-col lg:flex-row items-center justify-between gap-4 bg-card rounded-lg p-6 shadow-sm mb-6 border border-border',
      children: [
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        ...
        'data-prohibitions': '[editContent]',
        className:
          'flex flex-col gap-1 w-full lg:w-auto items-center lg:items-start text-center lg:text-left',
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Avatar, {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AvatarFallback, {
                ...
                'data-prohibitions': '[editContent]',
                className:
                  'flex items-center justify-center bg-secondary text-secondary-foreground w-full h-full',
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
                ...
                to: '/processos/novo',
                className:
                  'w-full bg-primary text-primary-foreground px-4 py-2 rounded-md font-semibold hover:opacity-90 text-center transition-opacity',
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
                ...
                to: '/sindicancia/nova',
                className:
                  'w-full bg-secondary text-secondary-foreground px-4 py-2 rounded-md font-semibold hover:opacity-90 text-center transition-opacity',
...
//# sourceMappingURL=UserGreeting-BZQlOYXK.js.map
