...
import { c as ZodError, o as object, s as string } from './schemas-DlcdjC99.js'
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SheetTrigger, {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('button', {
          ...
          'data-prohibitions': '[]',
          className:
            'inline-flex h-9 items-center justify-center rounded-md bg-[var(--primary,theme(colors.primary.DEFAULT))] px-4 py-2 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:opacity-50',
          children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('select', {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('option', {
                        'data-uid':
                          'src/pages/financeiro/components/GerarNotaFiscalSheet.tsx:67:15',
                        'data-prohibitions': '[]',
                        value: '',
                        disabled: true,
                      ...
                      periodos.length === 0 &&
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)('option', {
                          'data-uid':
                            'src/pages/financeiro/components/GerarNotaFiscalSheet.tsx:70:41',
                          'data-prohibitions': '[]',
                          disabled: true,
                      ...
                      periodos.map((p) =>
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                          ...
                          {
                            'data-uid':
                              'src/pages/financeiro/components/GerarNotaFiscalSheet.tsx:72:17',
                            'data-prohibitions': '[editContent]',
                            value: p.id,
                            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)('button', {
                    ...
                    className:
                      'inline-flex h-9 items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 disabled:opacity-50',
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        ...
        children: [
          ...
          canManage &&
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GerarNotaFiscalSheet, {
                                  ...
                                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                    ...
                                    children: [
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('button', {
                                        ...
                                        className:
                                          'p-1.5 text-muted-foreground hover:text-blue-600 disabled:opacity-30 disabled:hover:text-muted-foreground transition-colors rounded-md hover:bg-muted',
                                        title: 'Marcar como Enviada',
                                        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                          Mail,
                                          {
                                            'data-uid':
                                              'src/pages/financeiro/NotasFiscais.tsx:162:29',
                                            'data-prohibitions': '[editContent]',
                                            className: 'w-4 h-4',
                                          },
                                        ),
                                      ...
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('button', {
                                        ...
                                        className:
                                          'p-1.5 text-muted-foreground hover:text-teal-600 disabled:opacity-30 disabled:hover:text-muted-foreground transition-colors rounded-md hover:bg-muted',
                                        title: 'Registrar Pagamento',
                                        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                          Check,
                                          {
                                            'data-uid':
                                              'src/pages/financeiro/NotasFiscais.tsx:170:29',
                                            'data-prohibitions': '[editContent]',
                                            className: 'w-4 h-4',
                                          },
                                        ),
                                      ...
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('button', {
                                        ...
                                        className:
                                          'p-1.5 text-muted-foreground hover:text-red-600 disabled:opacity-30 disabled:hover:text-muted-foreground transition-colors rounded-md hover:bg-muted',
                                        title: 'Cancelar NF',
                                        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, {
                                          'data-uid':
                                            'src/pages/financeiro/NotasFiscais.tsx:178:29',
                                          'data-prohibitions': '[editContent]',
                                          className: 'w-4 h-4',
                                        }),
                                      }),
...
//# sourceMappingURL=NotasFiscais-BnbimVKI.js.map
