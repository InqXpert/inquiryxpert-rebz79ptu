...
import { i as parseISO, t as cn } from './utils-BmdpXeKV.js'
...
import { d as toast } from './index-DJeO_T7s.js'
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            ...
            'data-prohibitions': '[editContent]',
            className:
              'bg-card border border-border rounded-lg p-4 shadow-sm flex flex-col items-center justify-center gap-2 min-h-24 hover:shadow-md hover:scale-105 transition-all duration-200 ease-in-out',
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                'data-uid': 'src/components/PerformanceSection.tsx:22:11',
                'data-prohibitions': '[]',
                className:
                  'text-xs font-semibold text-muted-foreground uppercase tracking-wide text-center',
...
//# sourceMappingURL=PerformanceSection-Bqy2_-Cl.js.map
