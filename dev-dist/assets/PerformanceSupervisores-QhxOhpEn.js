...
function PerformanceSupervisores() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
    ...
    'data-prohibitions': '[editContent]',
    className:
      'w-full max-w-[1600px] mx-auto px-4 sm:px-6 md:px-8 py-6 md:py-8 space-y-8 animate-in fade-in zoom-in-95 duration-300',
    children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                        ...
                        'data-prohibitions': '[editContent]',
                        className:
                          'w-12 h-12 rounded-full bg-muted/50 flex items-center justify-center',
                        children: kpi.icon,
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
