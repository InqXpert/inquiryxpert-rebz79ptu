      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('h1', {
            ...
            children: [
              'Sindicancia ',
              processo?.numero_controle || processo?.id || record.processo_id,
            ],
          }),
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardContent, {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
              ...
              'data-prohibitions': '[editContent]',
              className:
                'bg-muted/30 p-5 rounded-lg font-mono text-sm whitespace-pre-wrap text-muted-foreground border border-border/50',
                ...
                ? record.documentos.map((doc, idx) =>
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                      'div',
                      {
                        ...
                        'data-prohibitions': '[editContent]',
                        className:
                          'flex items-center justify-between p-3 border border-border/50 rounded-lg bg-background hover:bg-muted/5 transition-colors',
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
...
//# sourceMappingURL=SindicanciaDetail-Br3dyebL.js.map
