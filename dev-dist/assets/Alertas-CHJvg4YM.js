...
var AlertIcon = ({ tipo, className }) => {
  switch (tipo) {
    ...
    case 'DUPLICADO':
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Layers, {
        'data-uid': 'src/pages/Alertas.tsx:46:14',
        'data-prohibitions': '[editContent]',
        className,
      })
    default:
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BellRing, {
...
function Alertas() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
    ...
    'data-prohibitions': '[editContent]',
    className:
      'w-full px-4 md:px-8 py-6 md:py-8 space-y-6 max-w-7xl mx-auto animate-in fade-in duration-500',
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            ...
            children: [
              user &&
                ['c-level', 'admin', 'supervisor'].includes(user.role) &&
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                        ...
                        'data-prohibitions': '[]',
                        className:
                          'w-16 h-16 rounded-full bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center mb-4',
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    Card,
                    {
                      ...
                      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
                        ...
                        'data-prohibitions': '[editContent]',
                        className:
                          'p-4 sm:p-6 flex flex-col sm:flex-row gap-5 items-start sm:items-center justify-between',
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                ...
                                children: [
                                  ...
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                    ...
                                    'data-prohibitions': '[editContent]',
                                    className:
                                      'flex items-center gap-x-4 gap-y-1 mt-3 text-xs text-muted-foreground flex-wrap',
                                    children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                            ...
                            'data-prohibitions': '[editContent]',
                            className:
                              'flex items-center gap-2 shrink-0 w-full sm:w-auto mt-2 sm:mt-0 justify-end',
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
...
//# sourceMappingURL=Alertas-CHJvg4YM.js.map
