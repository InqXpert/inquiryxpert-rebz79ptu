...
import './select-WobNQKSt.js'
import './use-municipios-BYXKcPF2.js'
import { t as CircleCheck } from './circle-check-CSFqsJLD.js'
import { a as Copy } from './tooltip-D26Yt2Gn.js'
...
import { t as Mail } from './mail-BbUyqolF.js'
import { t as MapPin } from './map-pin-BTSuVZ-G.js'
import { t as Star } from './star-Doyu2wsK.js'
...
import { l as fetchProcessos } from './procesosOperacionais-QbmNogI8.js'
import {
  n as DialogContent,
  o as DialogTitle,
...
import './textarea-BWQ2EUcv.js'
import './label-B6kYntjL.js'
import { i as useForm, t as a } from './zod-2HxOWlHO.js'
import { i as updateAgente, n as getAgente, t as deleteAgente } from './agentes-Cm62P0yd.js'
import './popover-X-c-rr-V.js'
import {
  n as ImportedFieldsContext,
  r as agenteSchema,
  t as FormContent,
} from './FormContent-DluIMoQT.js'
import { t as Form } from './form-D3BzudZl.js'
...
function EditAgenteModal({ open, onOpenChange, agente, onSuccess }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
      ...
      'data-prohibitions': '[editContent]',
      className:
        'max-w-4xl max-h-[90vh] overflow-y-auto w-11/12 rounded-2xl p-0 gap-0 border-none bg-muted/10 shadow-2xl',
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
          'data-uid': 'src/components/agentes/EditAgenteModal.tsx:64:9',
          'data-prohibitions': '[]',
          className:
            'bg-white p-6 sm:p-8 border-b border-border sticky top-0 z-10 flex flex-col gap-2',
          children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Form, {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('form', {
              ...
              className: 'space-y-8',
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ImportedFieldsContext.Provider, {
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                      ...
                      disabled: saving,
                      className:
                        'rounded-xl h-12 px-8 bg-primary hover:bg-primary/90 text-primary-foreground font-bold shadow-sm',
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        ...
        'data-prohibitions': '[]',
        className:
          'flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-4',
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
            ...
            size: 'sm',
            className:
              'gap-2 text-[15px] font-semibold text-muted-foreground hover:text-primary hover:bg-transparent px-0',
            asChild: true,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                ...
                className:
                  'text-destructive hover:bg-destructive/10 hover:text-destructive h-11 px-4 rounded-xl flex-1 sm:flex-none font-semibold',
                title: 'Remover',
                children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                ...
                className:
                  'h-11 px-6 rounded-xl gap-2 font-semibold flex-1 sm:flex-none border-border',
                children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
        ...
        'data-prohibitions': '[editContent]',
        className:
          'border border-border/50 shadow-sm rounded-2xl overflow-hidden animate-in fade-in duration-300 ease-out bg-card',
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
          'data-uid': 'src/pages/agentes/Profile.tsx:207:9',
          'data-prohibitions': '[editContent]',
          className:
            'p-8 md:p-10 grid grid-cols-1 lg:grid-cols-[240px_1fr_1fr_1fr] gap-10 md:items-start',
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
              ...
              children: [
                ...
                p.numero_controle &&
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                    ...
                    'data-prohibitions': '[editContent]',
                    className:
                      'flex items-center gap-2 mt-3 bg-primary/5 text-primary px-4 py-2 rounded-xl border border-primary/10',
                    children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
                  ...
                  variant: 'outline',
                  className:
                    'text-[13px] mt-4 bg-muted text-muted-foreground font-semibold border-none px-4 py-1.5 rounded-full',
                  ...
                  children: [
                    p.naBlackList === 'Sim' &&
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                        ...
                        'data-prohibitions': '[]',
                        className:
                          'bg-destructive/10 text-destructive text-[13px] font-bold px-4 py-1.5 rounded-full flex gap-2 items-center',
                        children: [
                    ...
                    p.ativo === 'Sim' &&
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                        ...
                        'data-prohibitions': '[]',
                        className:
                          'bg-emerald-100 text-emerald-800 text-[13px] font-bold px-4 py-1.5 rounded-full flex gap-2 items-center',
                        children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)('h3', {
                  ...
                  'data-prohibitions': '[]',
                  className:
                    'text-[13px] font-bold text-muted-foreground uppercase tracking-wider mb-2',
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                          ...
                          'data-prohibitions': '[]',
                          className:
                            'w-10 h-10 rounded-xl bg-muted/50 flex items-center justify-center shrink-0 border border-border/50',
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                              ...
                              'data-prohibitions': '[editContent]',
                              className:
                                'text-[15px] text-foreground font-semibold truncate max-w-[150px]',
                              title: p.chavePix,
                              children: p.chavePix || '-',
                            }),
                          ],
          ...
          : [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                Card,
                {
                  ...
                  'data-prohibitions': '[editContent]',
                  className:
                    'border border-border/50 shadow-sm rounded-2xl overflow-hidden relative bg-card animate-in fade-in slide-in-from-bottom-4 ease-out fill-mode-both',
                  style: {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('h4', {
                        ...
                        'data-prohibitions': '[editContent]',
                        className:
                          'text-[15px] font-semibold text-muted-foreground mb-3 relative z-10',
                        children: kpi.title,
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                        ...
                        'data-prohibitions': '[editContent]',
                        className:
                          'text-[13px] text-muted-foreground font-medium mt-3 relative z-10',
                    ...
                    : recentes.map((proc, i) =>
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                          'div',
                          {
                            ...
                            'data-prohibitions': '[editContent]',
                            className:
                              'py-5 hover:bg-muted/20 transition-colors animate-in fade-in slide-in-from-bottom-2 ease-out fill-mode-both flex flex-row items-center justify-between group',
                            style: {
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                ...
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                                    ...
                                    'data-prohibitions': '[editContent]',
                                    className:
                                      'text-[13px] text-muted-foreground font-bold tracking-wide',
                                  ...
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                                    ...
                                    'data-prohibitions': '[editContent]',
                                    className:
                                      'text-[16px] text-foreground font-bold mt-1.5 group-hover:text-primary transition-colors',
                      ...
                      children: [
                        i !== arr.length - 1 &&
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                            ...
                            'data-prohibitions': '[editContent]',
                            className:
                              'absolute left-[7px] top-4 w-[2px] h-[calc(100%-8px)] bg-border/50',
                          }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                          'data-uid': 'src/pages/agentes/Profile.tsx:521:17',
                          'data-prohibitions': '[editContent]',
                          className:
                            'w-4 h-4 rounded-full bg-secondary/20 border-2 border-secondary mt-1 shrink-0 relative z-10',
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
...
//# sourceMappingURL=Profile-DMGhrD3e.js.map
