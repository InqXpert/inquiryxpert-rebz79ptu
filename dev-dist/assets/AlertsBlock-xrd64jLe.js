...
import { a as format, p as startOfDay } from './utils-BmdpXeKV.js'
    ...
    try {
      ...
      const sortedPriority = priorityRes.items
        .sort((a, b) => {
          ...
          return (
            (a.data_prazo ? new Date(a.data_prazo).getTime() : Infinity) -
            (b.data_prazo ? new Date(b.data_prazo).getTime() : Infinity)
          )
        })
        .slice(0, 3)
...
var AlertsBlock = (0, import_react.memo)(function AlertsBlock() {
  ...
  const filteredOverdue = (0, import_react.useMemo)(
    () => filterByDate(overdue),
    [overdue, selectedDate],
  )
  const filteredUpcoming = (0, import_react.useMemo)(
    () => filterByDate(upcoming),
    [upcoming, selectedDate],
  )
  const filteredPriority = (0, import_react.useMemo)(
    () => filterByDate(priority),
    [priority, selectedDate],
  )
  const dateQuery = selectedDate ? `&date=${format(selectedDate, 'yyyy-MM-dd')}` : ''
  const renderItem = (item, highlightClass, text) =>
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            ...
            'data-prohibitions': '[editContent]',
            className:
              'bg-card rounded-lg p-4 border-l-4 border-l-destructive shadow-sm hover:shadow-md transition-all duration-200',
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                ...
                : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
                        ...
                        className:
                          'text-sm text-primary cursor-pointer hover:underline mt-2 block font-medium',
                        children: 'Ver Todos →',
                      }),
                    ],
                  }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            ...
            'data-prohibitions': '[editContent]',
            className:
              'bg-card rounded-lg p-4 border-l-4 border-l-accent shadow-sm hover:shadow-md transition-all duration-200',
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            ...
            'data-prohibitions': '[editContent]',
            className:
              'bg-card rounded-lg p-4 border-l-4 border-l-primary shadow-sm hover:shadow-md transition-all duration-200',
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)('button', {
          ...
          className:
            'bg-primary text-primary-foreground px-6 py-2 rounded-md font-semibold hover:opacity-90 transition-opacity w-full sm:w-auto',
...
//# sourceMappingURL=AlertsBlock-xrd64jLe.js.map
