...
import { t as Star } from './star-Dylpn6ch.js'
import {
  _ as startOfWeek,
  a as format,
  b as constructFrom,
...
import { t as addDays } from './addDays-uSgVYwet.js'
import { t as startOfMonth } from './startOfMonth-mhs9LkLq.js'
...
import {
  _ as searchByNumero,
  d as filterByDate,
  f as filterByFavorites,
  g as markProcessosAsRead,
  m as filterByStatus,
  p as filterByPriority,
  s as fetchFavoritos,
  u as fetchProcessosAgente,
  y as toggleProcessoFavorite,
} from './processosService-BIhEaTIB.js'
import { n as PopoverContent, r as PopoverTrigger, t as Popover } from './popover-BXTLxErq.js'
import './gestaoAgentes-Bxyt6pZi.js'
import { t as useGestaoAgentes } from './useGestaoAgentes-BlQZ3qok.js'
...
function useProcessosAgente(
  ...
  useRealtime(
    ...
    (e) => {
      if (e.action === 'create') {
        ...
        setProcessosRaw((prev) => prev.map((p) => (p.id === e.record.id ? e.record : p)))
  ...
  const exportSelected = () => {
    ...
    const csvContent = [
      ['Numero Controle', 'Segurado', 'Status', 'Prazo'].join(','),
      ...selectedProcs.map(
        (p) =>
...
function ProcessoQuickViewSheet({ processo, isOpen, onClose }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sheet, {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SheetContent, {
      ...
      'data-prohibitions': '[editContent]',
      className:
        'w-full sm:max-w-md p-0 flex flex-col h-full bg-background border-l border-border shadow-2xl',
      children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                  ...
                  'data-prohibitions': '[editContent]',
                  className:
                    'flex flex-col gap-1.5 p-4 rounded-xl bg-muted/30 border border-border/50',
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('span', {
                      'data-uid': 'src/components/operacional/ProcessoQuickViewSheet.tsx:65:15',
                      'data-prohibitions': '[]',
                      className:
                        'text-xs text-muted-foreground font-semibold uppercase flex items-center gap-1.5',
                      children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                  ...
                  'data-prohibitions': '[editContent]',
                  className:
                    'text-sm font-medium text-foreground p-4 bg-muted/30 rounded-xl border border-border/50',
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                  ...
                  'data-prohibitions': '[editContent]',
                  className:
                    'text-sm text-foreground leading-relaxed whitespace-pre-wrap p-4 bg-muted/30 rounded-xl border border-border/50',
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button$1, {
            ...
            'data-prohibitions': '[]',
            className:
              'w-full h-12 rounded-xl text-[15px] shadow-md transition-all hover:-translate-y-0.5',
            onClick: () => {
              onClose()
    ...
    switch (status) {
      case 'em_andamento':
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
          ...
          'data-prohibitions': '[]',
          className:
            'bg-primary text-primary-foreground hover:bg-primary/90 border-transparent shadow-none',
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        ...
        'data-prohibitions': '[editContent]',
        className:
          'sticky top-0 z-20 bg-card py-[16px] px-[24px] border-b border-border flex flex-col md:flex-row flex-wrap gap-4 items-start md:items-center animate-in slide-in-from-top-2 duration-200 ease-in rounded-xl shadow-sm mb-6',
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
                    ...
                    className:
                      'pl-9 w-full bg-card focus-visible:ring-primary focus-visible:border-primary',
                    value: searchTerm,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button$1, {
            ...
            className:
              'text-foreground hover:opacity-80 hover:bg-transparent w-full md:w-auto md:ml-auto',
      ...
      loading
        ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                ...
                'data-prohibitions': '[editContent]',
                className:
                  'hidden md:block overflow-x-auto border border-border/60 rounded-xl bg-card shadow-sm',
        ...
        : totalCount === 0
          ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
              ...
              'data-prohibitions': '[]',
              className:
                'flex flex-col items-center justify-center py-[60px] px-[24px] text-center bg-card rounded-xl border border-border animate-in fade-in duration-300',
              children: [
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Table, {
                      ...
                      children: [
                          ...
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableRow, {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                                ...
                                'data-prohibitions': '[]',
                                className:
                                  'text-muted-foreground font-bold sticky left-0 bg-muted/50 z-10 w-[200px]',
                                children: 'Número',
                              }),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableBody, {
                          ...
                          'data-prohibitions': '[editContent]',
                          children: processos.map((proc, idx) =>
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                              TableRow,
                              {
                                ...
                                children: [
                                    ...
                                    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                      Button$1,
                                      {
                                        ...
                                        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                          ...
                                          {
                                            'data-uid':
                                              'src/pages/gestao-agentes/Processos.tsx:385:25',
                                            'data-prohibitions': '[editContent]',
                                            className: cn(
                                  ...
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
                                    ...
                                    'data-prohibitions': '[editContent]',
                                    className:
                                      'sticky left-0 z-10 font-medium text-foreground transition-colors border-r border-transparent',
                                  ...
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
                                    ...
                                    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                                      ...
                                      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                        ...
                                        {
                                          'data-uid':
                                            'src/pages/gestao-agentes/Processos.tsx:417:25',
                                          'data-prohibitions': '[]',
                                          variant: 'ghost',
                                          size: 'icon',
                                          className:
                                          ...
                                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                            ...
                                            {
                                              'data-uid':
                                                'src/pages/gestao-agentes/Processos.tsx:426:27',
                                              'data-prohibitions': '[editContent]',
                                              className: 'w-4 h-4',
                                            },
                                          ),
                          ...
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
                            ...
                            children: [
                                    ...
                                    children: [
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                                        ...
                                        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                          ...
                                          {
                                            'data-uid':
                                              'src/pages/gestao-agentes/Processos.tsx:452:25',
                                            'data-prohibitions': '[editContent]',
                                            checked: selectedIds.has(proc.id),
                                            onCheckedChange: () => toggleSelection(proc.id),
                                            className: 'mt-1',
                                      ...
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                                        ...
                                        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                          ...
                                          {
                                            'data-uid':
                                              'src/pages/gestao-agentes/Processos.tsx:472:25',
                                            'data-prohibitions': '[editContent]',
                                            className: cn(
                                              'w-4 h-4 shrink-0',
                                              proc.is_favorite
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                ...
                                'data-prohibitions': '[editContent]',
                                className:
                                  'flex justify-between text-sm text-muted-foreground items-center ml-7',
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('span', {
      ...
      selectedIds.size > 0 &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
          ...
          'data-prohibitions': '[editContent]',
          className:
            'fixed bottom-6 left-1/2 -translate-x-1/2 bg-foreground text-background px-6 py-3 rounded-full shadow-2xl flex items-center gap-4 z-50 animate-in slide-in-from-bottom-5',
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('span', {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button$1, {
              ...
              size: 'sm',
              className:
                'text-muted-foreground hover:bg-background/20 rounded-full text-xs h-8 px-2',
...
//# sourceMappingURL=Processos-B-IIt8Tn.js.map
