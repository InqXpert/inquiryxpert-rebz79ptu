...
import { A as AvatarFallback, j as AvatarImage, k as Avatar } from "./index-B5mxNu_L.js";
...
var UserGreeting = (0, import_react.memo)(function UserGreeting() {
	...
	const firstName = (user?.name || user?.nome || "Usuário").trim().split(" ")[0];
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			"data-prohibitions": "[editContent]",
			className: "flex flex-col items-center lg:items-end gap-3 w-full lg:w-auto shrink-0",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Avatar, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AvatarImage, {
					...
					"data-prohibitions": "[editContent]",
					className: "flex items-center justify-center bg-secondary text-secondary-foreground text-xl font-bold w-full h-full uppercase",
...
//# sourceMappingURL=UserGreeting-BKDdEpXs.js.map