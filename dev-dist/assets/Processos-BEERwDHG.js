...
import { n as BellRing, t as useAlertas } from "./useAlertas-hfwUX_7q.js";
import { a as SelectValue, i as SelectTrigger, l as ChevronDown, n as SelectContent, r as SelectItem, t as Select } from "./select-iDQl76Pw.js";
...
import { E as useAuth, G as useNavigate, P as Search, i as Input, j as Button, n as useToast, u as toast } from "./index-DJ6hfVKX.js";
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [Array.isArray(p.tags) && p.tags.length > 0 ? p.tags.slice(0, 2).map((tag) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
							...
							children: "-"
						}), Array.isArray(p.tags) && p.tags.length > 2 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Badge, {
...
function ProcessosTableRowMobile({ processo: p, index: i, expanded, onToggle, onOpenModal }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			(tags.length > 0 || Array.isArray(p.tags) && p.tags.length > 0) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [tags.map((t, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					children: t.label
				}, `calc-${idx}`)), Array.isArray(p.tags) && p.tags.map((tag, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
					"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:98:15",
					"data-prohibitions": "[editContent]",
			...
			expanded && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:109:9",
				"data-prohibitions": "[]",
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pen, {
									"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:119:15",
									"data-prohibitions": "[editContent]",
									className: "w-4 h-4 mr-2"
								}), " Editar Processo"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
									"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:122:15",
									"data-prohibitions": "[]",
									variant: "outline",
									size: "sm",
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(History, {
										"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:131:17",
										"data-prohibitions": "[editContent]",
										className: "w-4 h-4 mr-2"
									}), " Histórico"]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
									"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:133:15",
									"data-prohibitions": "[]",
									variant: "outline",
									size: "sm",
									className: "w-full bg-white dark:bg-brand-navy border-brand-teal/20 dark:border-brand-cyan/20 min-h-[44px]",
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageSquare, {
										"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:142:17",
										"data-prohibitions": "[editContent]",
										className: "w-4 h-4 mr-2"
									}), " Obs"]
								})]
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
								"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:145:13",
								"data-prohibitions": "[]",
								variant: "outline",
								size: "sm",
								className: "w-full bg-white dark:bg-brand-navy border-brand-teal/20 dark:border-brand-cyan/20 min-h-[44px]",
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Flag, {
									"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:154:15",
									"data-prohibitions": "[editContent]",
									className: "w-4 h-4 mr-2"
								}), " Posições"]
							})
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						"data-uid": "src/components/operacional/ProcessosTableRowMobile.tsx:160:11",
						"data-prohibitions": "[]",
...
//# sourceMappingURL=Processos-BEERwDHG.js.map