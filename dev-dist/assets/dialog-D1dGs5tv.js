      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Content, {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Close, {
            ...
            'data-prohibitions': '[]',
            className:
              'absolute right-4 top-4 rounded-sm text-foreground opacity-70 ring-offset-background transition-colors hover:opacity-100 hover:text-primary focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 disabled:pointer-events-none p-2',
            children: [
...
//# sourceMappingURL=dialog-D1dGs5tv.js.map
