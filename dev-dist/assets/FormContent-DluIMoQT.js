...
var novoAgenteSchema = agenteSchema
  .extend({
            ...
            ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tooltip, {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipContent, {
                    ...
                    'data-prohibitions': '[]',
                    className:
                      'bg-foreground text-background text-[11px] rounded-md px-[8px] py-[4px]',
...
function FormContent({ isNew = false }) {
  ...
  const cidadesOptions = estadoSelecionado
    ? getCitiesByState(estadoSelecionado).map((c) => ({
        label: c.nome,
        value: c.nome,
      }))
    : []
    ...
    children: [
      numeroControle &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
          ...
          'data-prohibitions': '[editContent]',
          className:
            'bg-primary text-primary-foreground p-5 rounded-2xl flex flex-col sm:flex-row justify-between items-start sm:items-center font-bold shadow-sm gap-4',
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
              ...
              onClick: handleCopy,
              className:
                'text-primary-foreground hover:text-primary hover:bg-white font-bold rounded-xl h-10 px-4 w-full sm:w-auto',
              children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                ...
                'data-prohibitions': '[]',
                className:
                  'col-span-full font-bold text-primary text-[15px] uppercase tracking-wider mb-2',
