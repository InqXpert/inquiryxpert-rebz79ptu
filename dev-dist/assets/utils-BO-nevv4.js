...
function formatDateBr(dateString) {
	...
	if (typeof dateString === "string" && /^\d{2}\/\d{2}\/\d{4}/.test(dateString)) return dateString.substring(0, 10);
	const date = typeof dateString === "string" ? parseISO(dateString) : new Date(dateString);
	if (!isValid(date)) {
		const fallbackDate = new Date(dateString);
		if (isValid(fallbackDate)) return format(fallbackDate, "dd/MM/yyyy", { locale: ptBR });
		return "-";
	}
	return format(date, "dd/MM/yyyy", { locale: ptBR });
}
//#endregion
export { minutesInDay as C, millisecondsInHour as S, clsx as T, startOfISOWeek as _, format as a, toDate as b, getISOWeek as c, isValid as d, isDate as f, getTimezoneOffsetInMilliseconds as g, normalizeDates as h, parseISO as i, enUS as l, startOfDay as m, formatDateBr as n, addLeadingZeros as o, differenceInCalendarDays as p, ptBR as r, getWeek as s, cn as t, startOfYear as u, startOfWeek as v, minutesInMonth as w, constructFrom as x, getDefaultOptions as y };

//# sourceMappingURL=utils-BO-nevv4.js.map