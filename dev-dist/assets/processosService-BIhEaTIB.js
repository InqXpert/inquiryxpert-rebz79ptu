...
var transcribeAudio = async (processoId) => {
  return (
    (
      await pb.send('/backend/v1/transcribe', {
        method: 'POST',
...
var fetchProcessoById = async (id) => {
  return await pb
    ...
    .getOne(id, { expand: 'agente_id,supervisor_id,solicitante_id' })
}
...
//#endregion
export {
  validateDuplicidade as S,
  searchByNumero as _,
  createProcesso as a,
  transcribeAudio as b,
  fetchProcessoById as c,
  filterByDate as d,
  filterByFavorites as f,
  markProcessosAsRead as g,
  generateNumeroControle as h,
  createAuditLog as i,
  fetchProcessos as l,
  filterByStatus as m,
  calculateDiasTotais as n,
  deleteProcesso as o,
  filterByPriority as p,
  calculateTags as r,
  fetchFavoritos as s,
  calculateDayColor as t,
  fetchProcessosAgente as u,
  searchProcessos as v,
  updateProcesso as x,
  toggleProcessoFavorite as y,
}

//# sourceMappingURL=processosService-BIhEaTIB.js.map
